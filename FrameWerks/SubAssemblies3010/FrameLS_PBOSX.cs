...
namespace FrameWorks.Makes.System3010
{
    ...
    public class FrameLS_PBOSX : SubAssemblyBase
    {
        ...
        public FrameLS_PBOSX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3010-FrameLS_PBOSX";
        }
        ...
        public override void Build()
        {
            ...
            //TopTrackX
            part = new Part(3406, "TopTrackX", this, 1, (trackHelper.DoorPanelWidth * 3.0m) - stileOvrLpX2 + doorGap);
            ...
            // SplitHeadExtX ^^
            part = new Part(4364, "FaciaHeadExtX", this, 1, (trackHelper.DoorPanelWidth) - spltHdRed);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHdCap9 ^^
            part = new Part(4364, "SplitHdCap9", this, 1, FaciaCap9);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHdCap10 ^^
            part = new Part(4364, "SplitHdCap10", this, 1, FaciaCap10);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHdCap11 ^^
            part = new Part(4364, "SplitHdCap11", this, 1, FaciaCap11);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
