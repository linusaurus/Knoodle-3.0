...
{
    [Serializable()]
    public class NailFinMitered : SubAssemblyBase
    {
        ...
        public NailFinMitered()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3010-NailFinMitered";
        }
        ...
        public override void Build()
        {
            ...
            // NailerDepthExt
            part = new Part(3649, "NailerDepthExt", this, 2, m_subAssemblyDepth + nailFinAd - nailCrnRed);
            part.PartGroupType = "NailFin-Parts";
            part.PartLabel = "1)VERtMitCnr";
            m_parts.Add(part);
