...
namespace FrameWorks.Makes.System3010
{
    ...
    public class DrSwgBzPl3SDLFix : SubAssemblyBase
    {
        ...
        public DrSwgBzPl3SDLFix()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3010-DrSwgBzPl3SDLFix";
        }
        ...
        public override void Build()
        {
            ...
            // SMS_10_1/2_FH
            part = new Part(4933, "SMS_10_1/2_FH", this, 1, 0.0m);
            part.PartGroupType = "AssyBrackets-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
