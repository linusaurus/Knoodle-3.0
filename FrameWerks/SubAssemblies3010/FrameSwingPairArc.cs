...
namespace FrameWorks.Makes.System3010
{
    ...
    public class FrameSwingPairArch : SubAssemblyBase
    {
        ...
        public FrameSwingPairArch()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3010-FrameSwingPairArch";
        }
        ...
        public override void Build()
        {
            ...
            // HeadBrzPair ^^
            part = new Part(4306, "HeadBrzPair", this, 1, ((m_subAssemblyWidth * π) / 2.0m) + grip2X);
            part.PartGroupType = "Frame-Parts";
            ...
            // BRZ_ASTGL_COVER
            part = new Part(2972, "BRZ_ASTGL_COVER", this, 2, m_subAssemblyHieght - headReduct - botumRedut);
            ...
            // PVC ASTRAGAL
            part = new Part(1901, "PVC ASTRAGAL", this, 2, m_subAssemblyHieght - headReduct - botumRedut);
            part.PartGroupType = "HardWare-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
