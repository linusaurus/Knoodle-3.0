...
namespace FrameWorks.Makes.System2010
{
    ...
    public class FrameLS_XXXXP : SubAssemblyBase
    {
        ...
        const decimal facEndAcc = 3.9508m;
        ...
        public override void Build()
        {
            ...
            // SplitHeadExtXXXX ^^
            part = new Part(4362, "SplitHeadExtXXXX", this, 1, (trackHelper.DoorPanelWidth) - jambInset - spltHdRed);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHeadExtXXX ^^
            part = new Part(4362, "SplitHeadExtXXX", this, 1, (trackHelper.DoorPanelWidth) - faceMidoor);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHdCapX ^^
            part = new Part(4362, "SplitHdCapX", this, 3, faceCapX);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AccessCover ^^
            part = new Part(4362, "AccessCover", this, 3, facEndAcc);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // FacEndCap ^^
            part = new Part(4362, "FacEndCap", this, 3, facEndCap);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            part.PartGroupType = "Pile_LS_Sealss";
            part.PartLabel = "";
            m_parts.Add(part);
