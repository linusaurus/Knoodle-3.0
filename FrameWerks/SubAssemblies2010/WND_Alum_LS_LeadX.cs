...
namespace FrameWorks.Makes.System2010
{
    ...
    public class WND_Alum_LS_LeadX : SubAssemblyBase
    {
        ...
        public WND_Alum_LS_LeadX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2010-WND_Alum_LS_LeadX";
        }
        ...
        public override void Build()
        {
            ...
            // TopGuide5217
            part = new Part(5217, "TopGuide5212", this, 1, 0.0m);
            part.PartGroupType = "GuidesTop";
            part.PartLabel = "5217";
            m_parts.Add(part);
