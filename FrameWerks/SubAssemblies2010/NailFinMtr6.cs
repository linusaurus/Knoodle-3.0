...
namespace FrameWorks.Makes.System2010
{
    ...
    public class NailFinMtr6 : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // NailerWidthExt
            part = new Part(4373, "NailerWidthExt", this, 2, m_subAssemblyWidth + nailFinAd - nailFinRed);
            ...
            // NailerDepthExt
            part = new Part(4373, "NailerDepthExt", this, 2, m_subAssemblyDepth + nailFinAd - nailFinRed);
            part.PartGroupType = "NailFin";
            part.PartLabel = "1)MiterEnds";
            m_parts.Add(part);
