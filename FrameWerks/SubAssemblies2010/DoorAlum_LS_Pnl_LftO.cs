...
namespace FrameWorks.Makes.System2010
{
    ...
    public class DoorAlum_LS_Pnl_LftO : SubAssemblyBase
    {
        ...
        public DoorAlum_LS_Pnl_LftO()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2010-DoorAlum_LS_Pnl_LftO";
        }
        ...
        public override void Build()
        {
            ...
            // AlumGlsStpVLeft <<--
            part = new Part(4341, "AlumGlsStpVLeft", this, 2, m_subAssemblyHieght - stopReduceX2);
            ...
            // AlumGlsStpVRight -->
            part = new Part(4341, "AlumGlsStpVRight", this, 2, m_subAssemblyHieght - stopReduceX2);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
