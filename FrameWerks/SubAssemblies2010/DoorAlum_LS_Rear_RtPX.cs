...
namespace FrameWorks.Makes.System2010
{
    ...
    public class DoorAlum_LS_Rear_RtPX : SubAssemblyBase
    {
        ...
        public DoorAlum_LS_Rear_RtPX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2010-DoorAlum_LS_Rear_RtPX";
        }
        ...
        public override void Build()
        {
            ...
            // AlumGlsStpLeft <<--
            part = new Part(4341, "AlumGlsStpLeft", this, 2, m_subAssemblyHieght - stopReduceX2);
            ...
            // AlumGlsStpRight -->>
            part = new Part(4341, "AlumGlsStpRight", this, 2, m_subAssemblyHieght - stopReduceX2);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumGlsStpTop ^^
            part = new Part(4341, "AlumGlsStpTop", this, 2, m_subAssemblyWidth - stopReduceX2);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumGlsStpBot ||
            part = new Part(4341, "AlumGlsStpBot", this, 2, m_subAssemblyWidth - stopReduceX2);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // HDPE_LS_LockPocEdge
            part = new Part(4559, "HDPE_LS_LockPocEdge", this, 2, m_subAssemblyHieght);
            part.PartGroupType = "HDPE";
            part.PartLabel = labelStileL = "";
            m_parts.Add(part);
            ...
            // HDPETop
            part = new Part(5217, "HDPETop", this, 2, m_subAssemblyWidth);
            part.PartGroupType = "HDPE";
            ...
            part.PartGroupType = "GuidesTop";
            part.PartLabel = "4440__HalfGearP";
            m_parts.Add(part);
