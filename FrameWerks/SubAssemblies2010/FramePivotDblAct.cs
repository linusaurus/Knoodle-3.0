...
namespace FrameWorks.Makes.System2010
{
    ...
    public class FramePivotDblAct : SubAssemblyBase
    {
        ...
        public FramePivotDblAct()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2010-FramePivotDblAct";
        }
        ...
        public override void Build()
        {
            ...
            // JamAlumL -->> 
            part = new Part(911, "JamAlumL<|", this, 1, m_subAssemblyHieght - calkJoint);
            ...
            // JamAlumR -->>  
            part = new Part(911, "JamAlumR|>", this, 1, m_subAssemblyHieght - calkJoint);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
