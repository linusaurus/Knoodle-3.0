    ...
    public class DrSwg2x4RH : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                part = new Part(4314, "EPDM_PreSet", this, 1, (m_subAssemblyHieght - sidMuntGPExt2) / 4.0m);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                part = new Part(4284, "EPDM_Wedge", this, 1, (m_subAssemblyHieght - sidMuntGPInt2) / 4.0m);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
