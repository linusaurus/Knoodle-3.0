...
namespace FrameWorks.Makes.System2010AH
{
    ...
    public class FixedIG_4x2SDL : SubAssemblyBase
    {
        ...
        public FixedIG_4x2SDL()
        {
            ...
            this.ModelID = "System2010AH-FixedIG_4x2SDL";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(4588, "ExtMuntHorz", this, 1, (m_subAssemblyWidth - sidMuntGPExt2) / 4.0m);
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(4587, "IntMuntHorz", this, 1, (m_subAssemblyWidth - sidMuntGPInt2) / 4.0m);
                part.PartGroupType = "Muntins";
                part.PartLabel = "BEVEL_BISHOP_Ends";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 6; i++)
            {
                part = new Part(4588, "ExtMuntVert", this, 1, (m_subAssemblyWidth - sidMuntGPExt2) / 2.0m);
                part.PartGroupType = "Muntins";
            ...
            // EPDM_PreSet
            part = new Part(4314, "EPDM_PreSet", this, 2, m_subAssemblyWidth - sidMuntGPExt2);
            part.PartGroupType = "GlazingSeal";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // EPDM_Wedge
            part = new Part(4284, "EPDM_Wedge", this, 2, m_subAssemblyWidth - sidMuntGPInt2);
            part.PartGroupType = "GlazingSeal";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            //Cross_Bracket
            part = new Part(5267, "Cross_Bracket", this, 6, aluminumCrnBrk);
            part.PartGroupType = "AssyBrackets";
