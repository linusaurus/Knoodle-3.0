...
namespace FrameWorks.Makes.System2010AH
{
    ...
    public class FixedIG_4x3SDL : SubAssemblyBase
    {
        ...
        const decimal vrtMuntGPExt2 = 1.4527m * 2.0m;
        const decimal vrtMuntGPInt2 = 1.4585m * 2.0m;
        ...
        public FixedIG_4x3SDL()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2010AH-FixedIG_4x3SDL";
        }
        ...
        public override void Build()
        {
            ...
            // EPDM_PreSet
            part = new Part(4314, "EPDM_PreSet", this, 6, m_subAssemblyHieght - sidMuntGPExt2);
            part.PartGroupType = "GlazingSeal";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // EPDM_Wedge
            part = new Part(4284, "EPDM_Wedge", this, 6, m_subAssemblyHieght - sidMuntGPInt2);
            part.PartGroupType = "GlazingSeal";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            //Cross_Bracket
            part = new Part(5267, "Cross_Bracket", this, 12, aluminumCrnBrk);
            part.PartGroupType = "AssyBrackets";
