...
namespace FrameWorks.Makes.System2010AH
{
    ...
    public class DrSwgPr1X3ActRH : SubAssemblyBase
    {
        ...
        public DrSwgPr1X3ActRH()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3010-DrSwgPr1X3ActRH";
        }
        ...
        public override void Build()
        {
            ...
            // AlumGlsStpLeftDL |<<--
            part = new Part(4341, "AlumGlsStpLeftDL", this, 1, m_subAssemblyHieght - stopReduce - stopRedBot);
            ...
            // AlumGlsStpRightDL |-->>
            part = new Part(4341, "AlumGlsStpRightDL", this, 1, m_subAssemblyHieght - stopReduce - stopRedBot);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumGlsStpLeftDR <<--|
            part = new Part(4341, "AlumGlsStpLeftDR", this, 1, m_subAssemblyHieght - stopReduce - stopRedBot);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumGlsStpRightDR -->>|
            part = new Part(4341, "AlumGlsStpRightDR", this, 1, m_subAssemblyHieght - stopReduce - stopRedBot);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumGlsStpTopDL
            part = new Part(4341, "AlumGlsStpTopDL", this, 1, (m_subAssemblyWidth - stopRed2x - stopRedMid) / 2.0m);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumGlsStpTopDR
            part = new Part(4341, "AlumGlsStpTopDR", this, 1, (m_subAssemblyWidth - stopRed2x - stopRedMid) / 2.0m);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumGlsStpBotDL
            part = new Part(4341, "AlumGlsStpBotDL", this, 1, (m_subAssemblyWidth - stopRed2x - stopRedMid) / 2.0m);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumGlsStpBotDR
            part = new Part(4341, "AlumGlsStpBotDR", this, 1, (m_subAssemblyWidth - stopRed2x - stopRedMid) / 2.0m);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
