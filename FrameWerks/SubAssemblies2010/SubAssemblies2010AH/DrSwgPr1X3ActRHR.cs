...
namespace FrameWorks.Makes.System2010AH
{
    ...
    public class DrSwgPr1X3ActRHR : SubAssemblyBase
    {
        ...
        public DrSwgPr1X3ActRHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3010-DrSwgPr1X3ActRHR";
        }
        ...
        public override void Build()
        {
            ...
            // StileLeftDL |<<--
            part = new Part(4355, "StileLeftDL", this, 1, m_subAssemblyHieght - doorReduce - doorGapBot);
            ...
            // StileRightDL |-->>
            part = new Part(4355, "StileRightDL", this, 1, m_subAssemblyHieght - doorReduce - doorGapBot);
            part.PartGroupType = "AlumTB3inch";
            part.PartLabel = "1) Miter_Ends";
            m_parts.Add(part);
            ...
            // StileLeftDR <<--|
            part = new Part(4355, "StileLeftDR", this, 1, m_subAssemblyHieght - doorReduce - doorGapBot);
            part.PartGroupType = "AlumTB3inch";
            part.PartLabel = "1) Miter_Ends";
            m_parts.Add(part);
            ...
            // StileRightDR -->>|
            part = new Part(4355, "StileRightDR", this, 1, m_subAssemblyHieght - doorReduce - doorGapBot);
            part.PartGroupType = "AlumTB3inch";
            part.PartLabel = "1) Miter_Ends";
            m_parts.Add(part);
            ...
            // RailTopDL <|^^
            part = new Part(4355, "RailTopDL", this, 1, (m_subAssemblyWidth - doorReduceX2 - doorGapMid) / 2.0m);
            part.PartGroupType = "AlumTB3inch";
            part.PartLabel = "1) Miter_Ends ";
            m_parts.Add(part);
            ...
            // RailTopDR ^^>|
            part = new Part(4355, "RailTopDR", this, 1, (m_subAssemblyWidth - doorReduceX2 - doorGapMid) / 2.0m);
            part.PartGroupType = "AlumTB3inch";
            part.PartLabel = "1) Miter_Ends ";
            m_parts.Add(part);
            ...
            // RailBotDL <||
            part = new Part(4355, "RailBotDL", this, 1, (m_subAssemblyWidth - doorReduceX2 - doorGapMid) / 2.0m);
            part.PartGroupType = "AlumTB3inch";
            part.PartLabel = "1) Miter_Ends ";
            m_parts.Add(part);
            ...
            // RailBotDR ||>
            part = new Part(4355, "RailBotDR", this, 1, (m_subAssemblyWidth - doorReduceX2 - doorGapMid) / 2.0m);
            part.PartGroupType = "AlumTB3inch";
            part.PartLabel = "1) Miter_Ends ";
            m_parts.Add(part);
            ...
            // EPDM_PreSet
            part = new Part(4314, "EPDM_PreSet", this, 8, (m_subAssemblyWidth - sidMuntGPExt2 - centMuntGPExt) / 2.0m);
            part.PartGroupType = "Seal";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // EPDM_Wedge
            part = new Part(4284, "EPDM_Wedge", this, 8, (m_subAssemblyWidth - sidMuntGPInt2 - centMuntGPInt) / 2.0m);
            part.PartGroupType = "Seal";
            part.PartLabel = "";
            m_parts.Add(part);
