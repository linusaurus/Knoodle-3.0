...
namespace FrameWorks.Makes.System2010AH
{
    ...
    public class DrSwg2x3RH : SubAssemblyBase
    {
        ...
        public DrSwg2x3RH()
        {
            ...
            this.ModelID = "System3010-DrSwg2x3RH";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4270, "HDPEBot", this, 1, (m_subAssemblyWidth - doorReduceX2 + hdpExtX2));
                part.PartGroupType = "HDPE-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = labelStileR = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4341, "AlumGlsStpTopBot", this, 1, (m_subAssemblyWidth - stopRed2x));
                part.PartGroupType = "StopAlum-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
