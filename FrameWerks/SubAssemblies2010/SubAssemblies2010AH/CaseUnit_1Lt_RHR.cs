...
namespace FrameWorks.Makes.System2010AH
{
    ...
    public class CaseUnit_1Lt_RHR : SubAssemblyBase
    {
        ...
        public CaseUnit_1Lt_RHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2010-CaseUnit_1Lt_RHR";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(5280, "HingeFillerLR", this, 1, 0.0m);
                part.PartGroupType = "Hardware";
                part.PartLabel = "";
