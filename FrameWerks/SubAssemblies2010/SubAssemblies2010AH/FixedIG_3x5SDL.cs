...
namespace FrameWorks.Makes.System2010AH
{
    ...
    public class FixedIG_3x5SDL : SubAssemblyBase
    {
        ...
        public FixedIG_3x5SDL()
        {
            ...
            this.ModelID = "System2010AH-FixedIG_3x5SDL";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                part = new Part(4588, "ExtMuntHorz", this, 1, (m_subAssemblyWidth - sidMuntGPExt2) / 3.0m);
            ...
            for (int i = 0; i < 6; i++)
            {
                part = new Part(4587, "IntMuntHorz", this, 1,( m_subAssemblyWidth - sidMuntGPInt2) / 3.0m);
                part.PartGroupType = "Muntins";
                part.PartLabel = "BEVEL_BISHOP_Ends";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 11; i++)
            {
                part = new Part(4588, "ExtMuntVert", this, 1, (m_subAssemblyHieght - sidMuntGPExt2 - vrtMuntGPExt2) / 5.0m);
                part.PartGroupType = "Muntins";
                part.PartLabel = "BEVEL_BISHOP_Ends";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 11; i++)
            {
                part = new Part(4587, "IntMuntVert", this, 1, (m_subAssemblyHieght - sidMuntGPInt2 - vrtMuntGPInt2) / 5.0m);
                part.PartGroupType = "Muntins";
                part.PartLabel = "BEVEL_BISHOP_Ends";
                m_parts.Add(part);
            }
            ...
            // EPDM_PreSet
            part = new Part(4314, "EPDM_PreSet", this, 6, m_subAssemblyWidth - sidMuntGPExt2);
            part.PartGroupType = "GlazingSeal";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // EPDM_Wedge
            part = new Part(4284, "EPDM_Wedge", this, 6, m_subAssemblyWidth - sidMuntGPInt2);
            part.PartGroupType = "GlazingSeal";
            part.PartLabel = "";
            m_parts.Add(part);
