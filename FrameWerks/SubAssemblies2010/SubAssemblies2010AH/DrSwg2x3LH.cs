...
namespace FrameWorks.Makes.System2010AH
{
    ...
    public class DrSwg2x3LH : SubAssemblyBase
    {
        ...
        const decimal sidMuntGPExt2 = 3.9328m * 2.0m;
        const decimal sidMuntGPInt2 = 3.9382m * 2.0m;
        const decimal vrtMuntGPExt2 = 1.30269298m;
        const decimal vrtMuntGPInt2 = 1.31366373m;
        ...
        public DrSwg2x3LH()
        {
            ...
            this.ModelID = "System3010-DrSwg2x3LH";
        }
        ...
        public override void Build()
        {
            ...
            // PointSetScrew
            part = new Part(1545, "PointSetScrew", this, 13, 0.0m);
            part.PartGroupType = "AssyHrdwrFrame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part.PartLabel = "WELD_MITER_Ends";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part.PartGroupType = "Muntins";
                part.PartLabel = "BEVEL_MITER_Ends";
                m_parts.Add(part);
            }
            ...
            // AlumGlsStpVert
            part = new Part(4341, "AlumGlsStpVert", this, 2, m_subAssemblyHieght - stopReduce - stopRedBot);
            ...
            // AlumGlsStpTopBot
            part = new Part(4341, "AlumGlsStpTopBot", this, 2, (m_subAssemblyWidth - stopRed2x));
            part.PartGroupType = "StopAlum-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
