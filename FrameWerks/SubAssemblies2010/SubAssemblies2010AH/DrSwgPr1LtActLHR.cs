...
namespace FrameWorks.Makes.System2010AH
{
    ...
    public class DrSwgPr1LtActLHR : SubAssemblyBase
    {
        ...
        public DrSwgPr1LtActLHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "2010AH-DrSwgPr1LtActLHR";
        }
        ...
        public override void Build()
        {
            ...
            // PairShootStrike 
            part = new Part(5309, "PairShootStrike", this, 1, 0.0m);
            part.PartGroupType = "HardWare-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // RailBotRH
            part = new Part(4355, "RailBotRH", this, 1, (m_subAssemblyWidth - doorReduceX2 - doorGapMid) / 2.0m);
            part.PartGroupType = "AlumTB3inch";
            part.PartLabel = "1) Miter_Ends ";
            m_parts.Add(part);
            ...
            // AlumGlsStpBotRH
            part = new Part(4341, "AlumGlsStpBotRH", this, 1, (m_subAssemblyWidth - stopRed2x - stopRedMid) / 2.0m);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
