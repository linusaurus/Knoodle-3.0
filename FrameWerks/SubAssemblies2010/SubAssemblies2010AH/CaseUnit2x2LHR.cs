...
namespace FrameWorks.Makes.System2010AH
{
    ...
    public class CaseUnit2x2LHR : SubAssemblyBase
    {
        ...
        public CaseUnit2x2LHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2010AH-CaseUnit2x2LHR";
        }
        ...
        public override void Build()
        {
            ...
            // EPDM_PreSet
            part = new Part(4314, "EPDM_PreSet", this, 4, (m_subAssemblyWidth - sidMuntGPExt2) / 2.0m);
            part.PartGroupType = "Seal";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // EPDM_Wedge
            part = new Part(4284, "EPDM_Wedge", this, 4, (m_subAssemblyWidth - sidMuntGPInt2) / 2.0m);
            part.PartGroupType = "Seal";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // EPDM_PreSet
            part = new Part(4314, "EPDM_PreSet", this, 4, (m_subAssemblyHieght - sidMuntGPExt2) / 2.0m);
            part.PartGroupType = "Seal";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // EPDM_Wedge
            part = new Part(4284, "EPDM_Wedge", this, 4, (m_subAssemblyHieght - sidMuntGPInt2) / 2.0m);
            part.PartGroupType = "Seal";
            part.PartLabel = "";
            m_parts.Add(part);
