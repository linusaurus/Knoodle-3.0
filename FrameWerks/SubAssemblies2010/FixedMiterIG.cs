...
namespace FrameWorks.Makes.System2010
{
    ...
    public class FixedMiterIG : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // AlumFixMonoL <<--
            part = new Part(4344, "AlumFixMonoL", this, 1, m_subAssemblyHieght);
            ...
            // AlumFixMonoHead ^^
            part = new Part(4344, "AlumFixMonoHead", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "FrameAlumMtr";
            part.PartLabel = "VertMtr";
            m_parts.Add(part);

            //////////////////////////////////////////////////////////////////////////////

            // AlumFixMonoSill ||
            part = new Part(4344, "AlumFixMonoSill", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "FrameAlumMtr";
            part.PartLabel = "VertMtr";
            m_parts.Add(part);
            ...
            // AlumFixMonoHead ^^
            part = new Part(4344, "AlumFixMonoHead", this, 1, m_subAssemblyDepth);
            part.PartGroupType = "FrameAlumMtr";
            part.PartLabel = "VertMtr";
            m_parts.Add(part);
            ...
            // AlumFixMonoSill ||
            part = new Part(4344, "AlumFixMonoSill", this, 1, m_subAssemblyDepth);
            part.PartGroupType = "FrameAlumMtr";
            part.PartLabel = "VertMtr";
            m_parts.Add(part);
            ...
            //AlumGlsStpTop ^^  
            part = new Part(4341, "AlumGlsStpTop", this, 1, m_subAssemblyDepth - stopReduce - stopRedMitr);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "VertMtr";
            m_parts.Add(part);
            ...
            //AlumGlsStpBot ||  
            part = new Part(4341, "AlumGlsStpBot", this, 1, m_subAssemblyDepth - stopReduce - stopRedMitr);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "VertMtr";
            m_parts.Add(part);
