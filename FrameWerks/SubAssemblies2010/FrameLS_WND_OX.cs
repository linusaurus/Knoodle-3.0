...
namespace FrameWorks.Makes.System2010
{
    ...
    public class FrameLS_WND_OX : SubAssemblyBase
    {
        ...
        const decimal sillReduceExt = 2.5m;
        ...
        public FrameLS_WND_OX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2010-FrameLS_WND_OX";
        }
        ...
        public override void Build()
        {
            ...
            // SplitHeadWndExtX ^^
            part = new Part(4362, "SplitHeadWndExtX", this, 1, (m_subAssemblyWidth / 2.0m) - headCvrJmbRed - headCentRed);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SillAngleWndExt ^^
            part = new Part(4468, "SillAngleWndExt", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            part.PartThick = 2.50m;
