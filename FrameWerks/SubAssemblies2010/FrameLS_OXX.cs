...
namespace FrameWorks.Makes.System2010
{
    ...
    public class FrameLS_OXX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // FaciaHeadIntXXX_4 ^^
            part = new Part(4362, "FaciaHeadIntXXX_4", this, 1, m_subAssemblyWidth - jambDimW + doorGap - jambInset);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            ...
            // FaciaHeadExtO_1 ^^
            part = new Part(4362, "FaciaHeadExtO_1", this, 1, (trackHelper.DoorPanelWidth) - jambInset + splHdAdd);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            ...
            // FaciaHeadExtXX_2 ^^
            part = new Part(4362, "FaciaHeadExtXX_2", this, 1, (trackHelper.DoorPanelWidth) - spltHdRed + splHdAdd);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            ...
            // FaciaHeadExtXXX_3 ^^
            part = new Part(4362, "FaciaHeadExtXXX_3", this, 1, (trackHelper.DoorPanelWidth) - jambInset - spltHdRed);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            ...
            // Pile_LS_Seals ^^
            part = new Part(4384, "Pile_LS_Seals", this, 1, (trackHelper.DoorPanelWidth * 2.0m) - jambDimW + doorGap - jambInset);
            part.PartGroupType = "Pile_LS_Seals-Parts";
            part.PartLabel = "";
