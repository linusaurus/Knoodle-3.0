...
namespace FrameWorks.Makes.System2010
{
    ...
    public class FrameLS_OXX : SubAssemblyBase
    {
        ...
        const decimal splHdAdd = 4.4798m;
        const decimal spltHdRed = 6.9173m;
        const decimal uniTrackAdd = 2.25m;
        ...
        public FrameLS_OXX()
        {
            ...
            this.ModelID = "System2010-FrameLS_OXX";
        }
        ...
        public override void Build()
        {
            ...
            //TopTrackX
            part = new Part(3406, "TopTrackX", this, 1, (trackHelper.DoorPanelWidth * 2.0m) - stileOverLap + doorGap + uniTrackAdd);
            ...
            //TopTrackXX
            part = new Part(3406, "TopTrackXX", this, 1, ((trackHelper.DoorPanelWidth * 3.0m) - stileOvrLpX2) + doorGap);
            part.PartGroupType = "TopTrack";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // TopTrackO
            part = new Part(3406, "TopTrackO", this, 1, (trackHelper.DoorPanelWidth) + doorGap + yTrAccess);
            part.PartGroupType = "TopTrack";
            part.PartLabel = "";        
            m_parts.Add(part);
            ...
            // SplitHeadIntXXX_4 ^^
            part = new Part(4362, "SplitHeadIntXXX_4", this, 1, m_subAssemblyWidth - jambDimW + doorGap - jambInset);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHeadExtO_1 ^^
            part = new Part(4362, "SplitHeadExtO_1", this, 1, (trackHelper.DoorPanelWidth) - jambInset + splHdAdd);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHeadExtXX_2 ^^
            part = new Part(4362, "SplitHeadExtXX_2", this, 1, (trackHelper.DoorPanelWidth) - spltHdRed + splHdAdd);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHeadExtXXX_3 ^^
            part = new Part(4362, "SplitHeadExtXXX_3", this, 1, (trackHelper.DoorPanelWidth) - jambInset - spltHdRed);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHdCap9 ^^
            part = new Part(4362, "SplitHdCap9", this, 2, FaciaCap9);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHdCap10 ^^
            part = new Part(4362, "SplitHdCap10", this, 2, FaciaCap10);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHdCap11 ^^
            part = new Part(4362, "SplitHdCap11", this, 2, FaciaCap11);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AccessPlate ^^
            part = new Part(3438, "AccessPlate", this, 2, FaciaCap11);
            ...
            // Pile_LS_Seals ^^
            part = new Part(3979, "Pile_LS_Seals", this, 2, FaciaCap9);
            part.PartGroupType = "Pile_LS_Seals";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // Pile_LS_Seals ^^
            part = new Part(3979, "Pile_LS_Seals", this, 2, FaciaCap10);
            part.PartGroupType = "Pile_LS_Seals";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // Pile_LS_Seals ^^
            part = new Part(3979, "Pile_LS_Seals", this, 2, FaciaCap11);
            part.PartGroupType = "Pile_LS_Seals";
            part.PartLabel = "";
            m_parts.Add(part);
