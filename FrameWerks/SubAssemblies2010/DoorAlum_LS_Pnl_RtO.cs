...
namespace FrameWorks.Makes.System2010
{
    ...
    public class DoorAlum_LS_Pnl_RtO : SubAssemblyBase
    {
        ...
        public DoorAlum_LS_Pnl_RtO()
        {
            ...
            this.ModelID = "System2010-DoorAlum_LS_Pnl_RtO";
        }
        ...
        public override void Build()
        {
            ...
            // AlumGlsStpVLeft <<--
            part = new Part(4341, "AlumGlsStpVLeft", this, 1, m_subAssemblyHieght - stopReduceX2);
            ...
            // AlumGlsStpVRight -->>
            part = new Part(4341, "AlumGlsStpVRight", this, 1, m_subAssemblyHieght - stopReduceX2);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
