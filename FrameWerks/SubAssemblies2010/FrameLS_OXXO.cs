...
namespace FrameWorks.Makes.System2010
{
    ...
    public class FrameLS_OXXO : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // FaciaHeadInt ^^
            part = new Part(4362, "FaciaHeadInt", this, 1, m_subAssemblyWidth - jambReduce2X - doorGap2X);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            ...
            // FaciaHeadExtX ^^
            part = new Part(4362, "FaciaHeadExtX", this, 1, m_subAssemblyWidth - (trackHelper.DoorPanelWidth * 2.0m) - splitHeadRed  );
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4362, "FaciaHeadExtO", this, 1,  ((m_subAssemblyWidth - jambReduce2X + stileOvrLpX2 + doorGap ) / 4.0m ) + splitHdAdd  );
                part.PartGroupType = "Frame-Parts";
                part.PartLabel = "";
