...
namespace FrameWorks.Makes.System2010
{
    ...
    public class FrameLS_OXXO : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // TopTrackLO
            part = new Part(3406, "TopTrackLO", this, 2, ((m_subAssemblyWidth - jambReduce2X + stileOvrLpX2 + doorGap) / 4.0m) + yTrackAdd);
            part.PartGroupType = "TopTrack";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // TopTrackRO
            part = new Part(3406, "TopTrackRO", this, 2, ((m_subAssemblyWidth - jambReduce2X + stileOvrLpX2 + doorGap) / 4.0m) + yTrackAdd);
            part.PartGroupType = "TopTrack";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHeadInt ^^
            part = new Part(4362, "SplitHeadInt", this, 1, m_subAssemblyWidth - jambReduce2X - doorGap2X);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHeadExtX ^^
            part = new Part(4362, "SplitHeadExtX", this, 1, m_subAssemblyWidth - (trackHelper.DoorPanelWidth * 2.0m) - splitHeadRed  );
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHeadExtO ^^
            part = new Part(4362, "SplitHeadExtO", this, 2,  ((m_subAssemblyWidth - jambReduce2X + stileOvrLpX2 + doorGap ) / 4.0m ) + splitHdAdd  );
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
