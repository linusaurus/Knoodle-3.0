...
namespace FrameWorks.Makes.System8000
{
    ...
    public class CaseSash1X2 : SubAssemblyBase
    {
        ...
        const decimal glassGap4X = 0.0625m * 4.0m;
        ...
        public CaseSash1X2()
        {
            ...
            this.ModelID = "System8000-CaseSash1X2";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(334, "GlsStpWdVert", this, 1, (m_subAssemblyHieght - topRailRed - botRailRed - muntRed) / 2.0m);
                part.PartGroupType = "GlassStopWood";
            ...
            {                
                ...
                part.PartLength = (m_subAssemblyHieght - topRailRed - botRailRed - muntRed - glassGap4X) / 2.0m; ;
