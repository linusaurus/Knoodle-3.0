...
namespace FrameWorks.Makes.System8000
{
    ...
    public class CaseSashFXArched : SubAssemblyBase
    {
        ...
        public CaseSashFXArched()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System8000-CaseSashFXArched";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(334, "GlsStpWdVert", this, 1, m_subAssemblyHieght - topRailRed - botRailRed);
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(334, "GlsStpWdArched", this, 1, m_subAssemblyWidth - stileRedX2);
                part.PartGroupType = "GlassStopWood-Parts";
                part.PartWidth = 0.625m;
                part.PartThick = 0.3125m;
                part.PartLabel = "";
            ...
            {                
                ...
                part.PartLength = (m_subAssemblyHieght - topRailRed - botRailRed - glassGap2X);
                part.PartThick = 0.25m;
                part.PartLabel = "Pattern";
                m_parts.Add(part);
            }
