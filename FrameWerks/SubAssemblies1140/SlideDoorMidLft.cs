...
namespace FrameWorks.Makes.System1140
{
    ...
    public class SlideDoorMidLft : SubAssemblyBase
    {
        ...
        public SlideDoorMidLft()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System1140-SlideDoorMidLft";
        }
        ...
        public override void Build()
        {
            ...
            //PileTSlot
            part = new Part(3959, "PileTSlot", this, 2, m_subAssemblyHieght);
