...
namespace FrameWorks.Makes.System1140
{
    ...
    public class SlideDoorLeadLft : SubAssemblyBase
    {
        ...
        public SlideDoorLeadLft()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System1140-SlideDoorLeadLft";
        }
        ...
        public override void Build()
        {
            ...
            part.PartLength = 0.2188m;
            part.PartThick = 0.9688m;
            m_parts.Add(part);

            // Stile316
            part = new Part(911, "Stile316", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "SSClad";
            part.PartLabel = "EdgeLead";
            part.PartWidth = 1.1875m;
            part.PartThick = 0.2188m;
            part.PartLength = 0.09375m;
            m_parts.Add(part);
            ...
            // CarriageBarX
            part = new Part(7387, "CarriageBarX", this, 1, m_subAssemblyWidth);
            ...
            // BearingAxel
            part = new Part(7337, "BearingAxel", this, FrameWorks.Functions.BearingCountByWeight(Wieght), 0.0m);
            part.PartGroupType = "Hardware";
            part.PartLabel = "";
            m_parts.Add(part);
