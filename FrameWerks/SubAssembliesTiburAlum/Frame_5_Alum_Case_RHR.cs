...
{
    [Serializable()]
    public class Frame_5_Alum_Case_RHR : SubAssemblyBase
    {
        ...
        public Frame_5_Alum_Case_RHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "TiburAlum-Frame_5_Alum_Case_RHR";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part.PartGroupType = "AlumAgl_5_CaseRHR-Parts";
