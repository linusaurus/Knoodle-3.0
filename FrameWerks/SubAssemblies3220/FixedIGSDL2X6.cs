...
namespace FrameWorks.Makes.System3220
{
    ...
    public class FixedIGSDL2X6 : SubAssemblyBase
    {
        ...
        const decimal glassShim = 0.0625m;
        ...
        const decimal muntinCenterX5 = 0.50m * 5.0m;
        const decimal muntinWidth = 1.25m;
        const decimal muntinWidthX2 = 2.0m * 1.25m;
        const decimal muntinWidthX3 = 3.0m * 1.25m;
        const decimal muntinWidthX5 = 5.0m * 1.25m;

        #endregion

        #region Constructor

        public FixedIGSDL2X6()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3220-FixedIGSDL2X6";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                part = new Part(6889, "BeadMuntin_Vert", this, 1, (m_subAssemblyHieght - frameStopX2 - muntinCenterX5 ) / 6.0m);
                part.PartGroupType = "BeadMuntin";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 6; i++)
            {
                part = new Part(6887, "MntVertExt", this, 1, (m_subAssemblyHieght - frameFxReduceX2 - muntinWidthX5) / 6.0m);
                part.PartGroupType = "Muntin_Flat";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            {
                part = new Part(6898);
                part.FunctionalName = "GlassSDL2x6";
                part.PartGroupType = "GlassSDL2x6-Parts";
                part.Qnty = 1;
                part.ContainerAssembly = this;
                part.PartWidth = m_subAssemblyWidth - glassReduce * 2.0m;
                part.PartLength = (m_subAssemblyHieght - glassReduce * 2.0m - glassShim) / 2.0m;
                part.PartThick = 1.0m;
