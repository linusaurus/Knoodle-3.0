...
namespace FrameWorks.Makes.System3220
{
    ...
    public class SashCase2X3RHR : SubAssemblyBase
    {
        ...
        public SashCase2X3RHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3220-SashCase2X3RHR";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                part = new Part(6887, "Muntin_FlatVertExt", this, 1, (m_subAssemblyHieght - muntSashRedX2 - muntinThick2X) / 3.0m);
                part.PartGroupType = "Muntin_Flat";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            {
                //GlazeWedgeSeals
                part = new Part(4399, "GlazeWedgeSeals", this, 1, m_subAssemblyWidth - muntSashRedX2);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
                m_parts.Add(part);
            }
