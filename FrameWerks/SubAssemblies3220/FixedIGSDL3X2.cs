...
namespace FrameWorks.Makes.System3220
{
    ...
    public class FixedIGSDL3X2 : SubAssemblyBase
    {
        ...
        public FixedIGSDL3X2()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3220-FixedIGSDL3X2";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(6889, "BeadMuntin_Vert", this, 1, (m_subAssemblyHieght - frameStopX2 - muntinCenter ) / 2.0m);
                part.PartGroupType = "BeadMuntin";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(6887, "MntVertExt", this, 1, (m_subAssemblyHieght - frameFxReduceX2 - muntinWidth) / 2.0m);
                part.PartGroupType = "Muntin_Flat";
                part.PartLabel = "";
                m_parts.Add(part);
            }
