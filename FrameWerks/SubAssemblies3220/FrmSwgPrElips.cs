...
namespace FrameWorks.Makes.System3220
{
    ...
    public class FrmSwgPrElips : SubAssemblyBase
    {
        ...
        const decimal frameThick = 1.250m;
        ...
        const decimal rise = 28.00m;

        #endregion

        #region Constructor

        public FrmSwgPrElips()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3220-FrmSwgPrElips";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4306, "JamBrzPair<", this, 1, m_subAssemblyHieght - rise - calkJoint);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4306, "HdBrzPrStretch_Form", this, 1, m_subAssemblyDepth);
                part.PartGroupType = "Frame-Parts";
            ...
            // BRZ_ASTGL_COVER
            part = new Part(2972, "BRZ_ASTGL_COVER", this, 1, m_subAssemblyHieght - frameThick - calkJoint - botumRedut);
            ...
            // PVC ASTRAGAL
            part = new Part(1901, "PVC ASTRAGAL", this, 1, m_subAssemblyHieght - frameThick - calkJoint - botumRedut);
            part.PartGroupType = "HardWare-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // StrikePair_RH_or_LHR
            part = new Part(5338, "StrikePair_RH_or_LHR", this, 1, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // ShootStrikePairCup 
            part = new Part(5309, "ShootStrikePairCup", this, 2, 0.0m);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
