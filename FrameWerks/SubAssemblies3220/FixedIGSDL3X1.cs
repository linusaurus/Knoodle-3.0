...
namespace FrameWorks.Makes.System3220
{
    ...
    public class FixedIGSDL3X1 : SubAssemblyBase
    {
        ...
        public FixedIGSDL3X1()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3220-FixedIGSDL3X1";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(6889, "BeadMuntin_Vert", this, 1, m_subAssemblyHieght - frameStopX2);
