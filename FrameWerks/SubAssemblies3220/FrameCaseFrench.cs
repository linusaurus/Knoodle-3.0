...
namespace FrameWorks.Makes.System3220
{
    ...
    public class FrameCaseFrench : SubAssemblyBase
    {
        ...
        const decimal astragalReduce = 0.875m * 2.0m;
        ...
        public FrameCaseFrench()
        {
            ...
            this.ModelID = "System3220-FrameCaseFrench";
        }
        ...
        public override void Build()
        {
            ...
            // Astragal
            part = new Part(3950, "Astragal", this, 1, m_subAssemblyHieght - astragalReduce);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(2274, "FrameSeal", this, 1, m_subAssemblyHieght - astragalReduce);
