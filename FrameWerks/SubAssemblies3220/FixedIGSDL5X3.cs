...
namespace FrameWorks.Makes.System3220
{
    ...
    public class FixedIGSDL5X3 : SubAssemblyBase
    {
        ...
        public FixedIGSDL5X3()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3220-FixedIGSDL5X3";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 12; i++)
            {
                part = new Part(6887, "MntVertExt", this, 1, (m_subAssemblyHieght - frameFxReduceX2 - muntinWidthX2) / 3.0m);
                part.PartGroupType = "Muntin_Flat";
                part.PartLabel = "";
                m_parts.Add(part);
            }
