...
namespace FrameWorks.Makes.System3220
{
    ...
    public class FrameLS_OXXO : SubAssemblyBase
    {
        ...
        public FrameLS_OXXO()
        {
            ...
            this.ModelID = "System3220-FrameLS_OXXO";
        }
        ...
        public override void Build()
        {
            ...
            //TopTrackX
            part = new Part(3406, "TopTrackX", this, 1, m_subAssemblyWidth - finishExt2X);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3406, "TopTrackO", this, 1, ((m_subAssemblyWidth - jambReduce2X + stileOvrLpX2 + doorGap) / 4.0m) + yTrackAdd);
                part.PartGroupType = "TopTrackY-Parts";
                part.PartLabel = "";
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(5426, "OTB_XO_XP", this, 1, 0.0m);
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(5425, "OTB_OX_PX", this, 1, 0.0m);
                part.PartGroupType = "Over_Travel";
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4363, "BrzJambXDoor", this, 1, m_subAssemblyHieght - calkGap);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4363, "BrzJambIntODoor", this, 1, m_subAssemblyHieght - reducHDPE - calkGap);
                part.PartGroupType = "Frame-Parts";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            // BrzSplitHeadInt ^^
            part = new Part(4364, "BrzSplitHeadInt", this, 1, m_subAssemblyWidth - jambReduce2X - doorGap2X);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // BrzSplitHeadExtX ^^
            part = new Part(4364, "BrzSplitHeadExtX", this, 1, m_subAssemblyWidth - (trackHelper.DoorPanelWidth * 2.0m) - splitHeadRed);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4364, "BrzSplitHeadExtO", this, 1, ((m_subAssemblyWidth - jambReduce2X + stileOvrLpX2 + doorGap) / 4.0m) + splitHdAdd);
                part.PartGroupType = "Frame-Parts";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 3; i++)
            {
                part = new Part(911, "Mntg_Block_O", this, 1, 0.0m);
                part.PartGroupType = "HDPE_Head";
                part.PartLabel = "";
                part.PartThick = 1.1644m;
