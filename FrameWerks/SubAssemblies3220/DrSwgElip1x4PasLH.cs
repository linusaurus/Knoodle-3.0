...
namespace FrameWorks.Makes.System3220
{
    ...
    public class DrSwgElip1x4PasLH : SubAssemblyBase
    {
        ...
        public DrSwgElip1x4PasLH()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3220-DrSwgElip1x4PasLH";
        }
        ...
        public override void Build()
        {
            ...
            // StileRight
            part = new Part(4312, "StileRight", this, 1, m_subAssemblyHieght - rise);
            part.PartGroupType = "BrzTB3inch";
            part.PartLabel = "1) Miter_Ends";
            m_parts.Add(part);
