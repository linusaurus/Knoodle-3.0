...
namespace FrameWorks.Makes.System3220
{
    ...
    public class FrameCaseRadLHR : SubAssemblyBase
    {
        ...
        public FrameCaseRadLHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3220-FrameCaseRadLHR";
        }
        ...
        public override void Build()
        {
            ...
            // JmbBrzL <<-- 
            part = new Part(4303, "JmbBrzL", this, 1, m_subAssemblyHieght - rise);
            ...
            // JmbBrzR -->> 
            part = new Part(4303, "JmbBrzR", this, 1, m_subAssemblyHieght - rise);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "1)MiterEnds" + "\r\n" +
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4303, "HdBrzStretch_Form", this, 1, m_subAssemblyDepth);
                part.PartGroupType = "Frame-Parts";
                part.PartLabel = "1)MiterEnds" + "\r\n" +
