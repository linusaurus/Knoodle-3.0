...
namespace FrameWorks.Makes.SubAssembliesFASTrack
{
    class FTPXXP : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // BladePXXP
            part = new Part(3444, "BladePXXP", this, 1, (trackHelper.DoorPanelWidth * 2) - pocketInset * 2.0m );
            ...
            part = new Part(3448, "NutPlateConPoc", this, (trackHelper.BridgeCount) * (panelCount), 0.0m);
            part.PartGroupType = "PocBrdgAssY-Parts";
            part.PartLabel = "";
