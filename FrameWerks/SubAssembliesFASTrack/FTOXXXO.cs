...
namespace FrameWorks.Makes.SubAssembliesFASTrack
{
    class FTOXXXO : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            part = new Part(3444, "BladeOX", this, 1, (trackHelper.DoorPanelWidth * 2) - stileWidth + jambFinwall );
            part.PartGroupType = "BladeSS-Parts";
            part.PartLabel = "";
            ...
            part = new Part(3444, "BladeOXX", this, 1, (trackHelper.DoorPanelWidth * 3) - (stileWidth * 2) + jambFinwall );
            part.PartGroupType = "BladeSS-Parts";
            part.PartLabel = "";
            ...
            part = new Part(3444, "BladeOXXXO", this, 1, (trackHelper.DoorPanelWidth * 5) + adjOdoor + bladeAdd * 2 - stileWidth * 4 + jambFinwall + bladeAdd);
            part.PartGroupType = "BladeSS-Parts";
            part.PartLabel = "";
