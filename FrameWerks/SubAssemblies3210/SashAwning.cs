...
namespace FrameWorks.Makes.System3210
{
    ...
    public class SashAwning : SubAssemblyBase
    {
        ...
        public SashAwning()
        {
            ...
            this.ModelID = "System3210-SashAwning";
        ...
        public override void Build()
        {
            ...
            // BrzGlsStpVt
            part = new Part(7134, "BrzGlsStpVt", this, 1, m_subAssemblyHieght - 2 * gstopReduce);
            ...
            // BrzGlsStpHz
            part = new Part(7134, "BrzGlsStpHz", this, 1, m_subAssemblyWidth - 2 * gstopReduce);
            part.PartGroupType = "StopBrz-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // BrzAnglFillVt
            part = new Part(4728, "BrzAnglFillVt", this, 1, m_subAssemblyHieght - 2 * gstopReduce);
            part.PartGroupType = "StopBrz-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // BrzAnglFillHz
            part = new Part(4728, "BrzAnglFillHz", this, 1, m_subAssemblyWidth - 2 * gstopReduce);
            part.PartGroupType = "StopBrz-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            part = new Part(502, "FH_8-32x3/16_SS", this, 16, 0.0m);
            part.PartGroupType = "AsemblHrdwr-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            part = new Part(1545, "SetSocScrew_1/4-20x3/8", this, 16, 0.0m);
            part.PartGroupType = "AsemblHrdwr-Parts";
            part.PartWidth = part.Source.Width;
            part.PartThick = part.Source.Height;
            part.PartLabel = "";
            ...
            // HingesJalousieLH
            part = new Part(1138, "HingesJalousieLH", this, 1, 0.0m);
            part.PartGroupType = "Hardware";
            part.PartLabel = "";
            m_parts.Add(part);

            // HingesJalousieRH
            part = new Part(1140, "HingesJalousieRH", this, 1, 0.0m);
            part.PartGroupType = "Hardware";
            part.PartLabel = "";
            m_parts.Add(part);
