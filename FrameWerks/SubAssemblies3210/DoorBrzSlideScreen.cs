...
namespace FrameWorks.Makes.System3210
{
    ...
    public class DoorBrzSlideScreen : SubAssemblyBase
    {
        ...
        public DoorBrzSlideScreen()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3210-DoorBrzSlideScreen";
        }
        ...
        public override void Build()
        {
            ...
            part = new Part(4000, "ACRE™edge", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "ACRE™";
            part.PartLabel = "SpocketEdge";
            part.PartThick = 0.6234m;
            part.PartWidth = 0.7045m;
            m_parts.Add(part);
