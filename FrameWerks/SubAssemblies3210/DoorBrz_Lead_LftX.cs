...
namespace FrameWorks.Makes.System3210
{
    ...
    public class DoorBrz_Lead_LftX : SubAssemblyBase
    {
        ...
        public DoorBrz_Lead_LftX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3210-DoorBrz_Lead_LftX";
        }
        ...
        public override void Build()
        {
            ...
            // AdamsRite_1874
            part = new Part(271, "AdamsRite_1874", this, 1, 0.0m);
            part.PartGroupType = "HardWare";
            part.PartLabel = "";
            m_parts.Add(part);

            // AdamsRite_4801
            part = new Part(268, "AdamsRite_4801", this, 1, 0.0m);
            part.PartGroupType = "HardWare";
            part.PartLabel = "";
            m_parts.Add(part);
