...
namespace FrameWorks.Makes.System3090
{
    ...
    public class DoorLS_MidBPanel : SubAssemblyBase
    {
        ...
        public DoorLS_MidBPanel()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3090-DoorLS_MidBPanel";
        }
        ...
        public override void Build()
        {
            ...
            // TopGuide4438
            part = new Part(4438, "TopGuide4438", this, 2, 0.0m);
            part.PartGroupType = "GuidesTop-Parts";
            ...
            // Squash_Pad_4897
            part = new Part(4897, "Squash_Pad_4897", this, 2, 0.0m);
            part.PartGroupType = "Seal-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
