    ...
    public class DoorLS2BPanels : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(5319, "StileHalfMid", this, 1, m_subAssemblyHieght);
                part.PartGroupType = "DoorBzTB-Parts";
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(5316, "BrzGlsStpTopBot", this, 1, ( m_subAssemblyWidth - stopReduceX2 - stopReduceMid ) / 2.0m);
                part.PartGroupType = "StopBrz-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
