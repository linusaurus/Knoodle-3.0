...
namespace FrameWorks.Makes.System3090
{
    ...
    public class DoorBrz_LS_Rear_RtO : SubAssemblyBase
    {
        ...
        public DoorBrz_LS_Rear_RtO()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3090-DoorBrz_LS_Rear_RtO";
        }
        ...
        public override void Build()
        {
            ...
            //{
                ...
                //part = new Part(5670, "HDPE_LS_JambEdge", this, 1, m_subAssemblyHieght);
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4897, "Squash_Pad_4897", this, 1, 0.0m);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
