...
namespace FrameWorks.Makes.System3090
{
    ...
    public class FixedWndFrmDrSash : SubAssemblyBase
    {
        ...
        public FixedWndFrmDrSash()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3090-FixedWndFrmDrSash";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4303, "JamBrz", this, 1, m_subAssemblyHieght);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4303, "HeadSillBrz", this, 1, m_subAssemblyWidth);
                part.PartGroupType = "Frame-Parts";
                part.PartLabel = "1)MiterEnds";
