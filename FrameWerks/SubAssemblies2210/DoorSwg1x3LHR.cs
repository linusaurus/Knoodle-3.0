...
namespace FrameWorks.Makes.System2210
{
    ...
    public class DoorSwg1x3LHR : SubAssemblyBase
    {
        ...
        public DoorSwg1x3LHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2210-DoorSwg1x3LHR";
        }
        ...
        public override void Build()
        {
            ...
            // Handle_Set
            part = new Part(4939, "Handle_Set", this, 1, 0.0m);
            part.PartGroupType = "TOKYO_ENTRY";
            part.PartLabel = "RH";
            m_parts.Add(part);
