...
namespace FrameWorks.Makes.System2210
{
    ...
    public class DoorAlum_LS_Mid_LftX : SubAssemblyBase
    {
        ...
        public DoorAlum_LS_Mid_LftX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2210-DoorAlum_LS_Mid_LftX";
        }
        ...
        public override void Build()
        {
            ...
            // SquashPadLS
            part = new Part(4897, "SquashPadLS", this, 2, 0.0m);
            part.PartGroupType = "HookCap";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // LS_HalfGear
            part = new Part(4096, "LS_HalfGear", this, 1, 0.0m);
