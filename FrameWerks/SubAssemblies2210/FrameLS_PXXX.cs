...
namespace FrameWorks.Makes.System2210
{
    ...
    public class FrameLS_PXXX : SubAssemblyBase
    {
        ...
        public FrameLS_PXXX()
        {
            ...
            this.ModelID = "System2210-FrameLS_PXXX";
        }
        ...
        public override void Build()
        {
            ...
            //TopTrackPXXX
            part = new Part(3406, "TopTrackPXXX", this, 1, (trackHelper.DoorPanelWidth * 4.0m - stileOvrLpX2) + trackAddPocket + doorGap + calkGap);
            ...
            //TopTrackPXX
            part = new Part(3406, "TopTrackPXX", this, 1, (trackHelper.DoorPanelWidth * 3.0m - stileOverLap) + trackAddPocket + trackAddOvTrav + calkGap);
            part.PartGroupType = "TopTrackUni";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            //TopTrackPX
            part = new Part(3406, "TopTrackPX", this, 1, (trackHelper.DoorPanelWidth * 2.0m + trackAddPocket) + trackAddOvTrav + calkGap);
            part.PartGroupType = "TopTrackUni";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHeadXXX ^^
            part = new Part(4362, "SplitHeadXXX", this, 1, m_subAssemblyWidth - jambPocRed - jambRed - jambInset2X);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHeadExt__X ^^
            part = new Part(4362, "SplitHeadExt__X", this, 1, trackHelper.DoorPanelWidth - jambInset - spltHdRed);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHeadExt_X_ ^^
            part = new Part(4362, "SplitHeadExt_X_", this, 1, trackHelper.DoorPanelWidth - faceMidoor);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            ...
            // SplitHeadExtX__ ^^
            part = new Part(4362, "SplitHeadExtX__", this, 1, trackHelper.DoorPanelWidth + faceXdoor - jambInset);
            part.PartGroupType = "Frame";
            part.PartLabel = "";
            m_parts.Add(part);
