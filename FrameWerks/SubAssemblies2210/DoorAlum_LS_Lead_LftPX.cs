...
namespace FrameWorks.Makes.System2210
{
    ...
    public class DoorAlum_LS_Lead_LftPX : SubAssemblyBase
    {
        ...
        public DoorAlum_LS_Lead_LftPX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2210-DoorAlum_LS_Lead_LftPX";
        }
        ...
        public override void Build()
        {
            ...
            // AlumGlsStpT ^^
            part = new Part(5711, "AlumGlsStpT", this, 1, m_subAssemblyWidth - stopReduceX2);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumGlsStpB ||
            part = new Part(5711, "AlumGlsStpB", this, 1, m_subAssemblyWidth - stopReduceX2);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // HDPE_LS_LockEdge1
            part = new Part(4266, "HDPE_LS_LockEdge1", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "HDPE";
            part.PartLabel = labelStileL = "";
            m_parts.Add(part);

            // HDPE_LS_LockEdge2
            part = new Part(4266, "HDPE_LS_LockEdge2", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "HDPE";
            part.PartLabel = labelStileL = "";
            m_parts.Add(part);
            ...
            // HDPETop
            part = new Part(5651, "HDPETop", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "HDPE";
            ...
            // LiftSlideGear
            part = new Part(3421, "LiftSlideGear", this, 1, 0.0m);
            ...
            // LockBoltKits
            part = new Part(3431, "LockBoltKits", this, 2, 0.0m);
            part.PartGroupType = "Hardware";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // ShimsLockBolt
            part = new Part(3383, "ShimsLockBolt", this, 2, 0.0m);
            part.PartGroupType = "Hardware";
            part.PartLabel = "";
            m_parts.Add(part);
