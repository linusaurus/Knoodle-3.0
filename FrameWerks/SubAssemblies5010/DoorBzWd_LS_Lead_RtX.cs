...
namespace FrameWorks.Makes.System5010
{
    ...
    public class DoorBzWd_LS_Lead_RtX : SubAssemblyBase
    {
        ...
        public DoorBzWd_LS_Lead_RtX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System5010-DoorBzWd_LS_Lead_RtX";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                part = new Part(5391, "HDPE_LS_LockEdge1", this, 1, m_subAssemblyHieght);
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                part = new Part(4780, "HDPE_LS_LockEdge2", this, 1, m_subAssemblyHieght);
                part.PartGroupType = "HDPE-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = labelStileL = "";
