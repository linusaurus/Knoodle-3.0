...
namespace FrameWorks.Makes.System5010
{
    ...
    public class DoorBzWd_LS_Rear_LftO : SubAssemblyBase
    {
        ...
        public DoorBzWd_LS_Rear_LftO()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System5010-DoorBzWd_LS_Rear_LftO";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                part = new Part(5504, "HDPE_Bottom_Stand", this, 1, m_subAssemblyHieght);
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(5214, "TopGuide5213", this, 1, 0.0m);
                part.PartGroupType = "GuidesTop-Parts";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                peri = FrameWorks.Functions.Perimeter(m_subAssemblyHieght - glassVinylX2, m_subAssemblyWidth - glassVinylX2);
                part = new Part(4284, "WedgeEPDM", this, 1, peri);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
