    ...
    public class FrameLS_PXXXXXXXXP : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                //TopTrackYPXX
                part = new Part(3406, "TopTrackYPXX", this, 1, (trackHelper.DoorPanelWidth * 3.0m) - stileOverLap + pockYtrackAdd + yTrAccess);
                part.PartGroupType = "TopTrackUni-Parts";
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                // TopTrackYPX
                part = new Part(3406, "TopTrackYPX", this, 1, (trackHelper.DoorPanelWidth * 2.0m) + pockYtrackAdd + yTrAccess);
                part.PartGroupType = "TopTrackUni-Parts";
                part.PartLabel = "";
