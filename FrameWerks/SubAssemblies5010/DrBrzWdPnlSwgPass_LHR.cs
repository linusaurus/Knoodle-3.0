...
namespace FrameWorks.Makes.System5010
{
    ...
    public class DrBrzWdPnlSwgPass_LHR : SubAssemblyBase
    {
        ...
        const decimal midRailRed2X = 2.0m * 3.0411m;

        #endregion

        #region Constructor

        public DrBrzWdPnlSwgPass_LHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System5010-DrBrzWdPnlSwgPass_LHR";
        }
        ...
        public override void Build()
        {
            ...
            // MidRext1
            part = new Part(4318, "MidRext1", this, 1, m_subAssemblyWidth - midRailRed2X);
            part.PartGroupType = "CheckRail";
            part.PartLabel = "1) Miter_Ends ";
            m_parts.Add(part);
            ...
            // MidRext2
            part = new Part(4318, "MidRext2", this, 1, m_subAssemblyWidth - midRailRed2X);
            part.PartGroupType = "CheckRail";
            part.PartLabel = "1) Miter_Ends ";
            m_parts.Add(part);
            ...
            //// MidRext3
            //part = new Part(4318, "MidRext3", this, 1, m_subAssemblyWidth - midRailRed2X);
            //part.PartGroupType = "CheckRail";
            //part.PartLabel = "1) Miter_Ends ";
            //m_parts.Add(part);
            ...
            part = new Part(1545, "MS_FlatHead_8-32x3/16_SS", this, 48, 0.0m);
            part.PartGroupType = "AssyBraces";
            part.PartLabel = "";
            m_parts.Add(part);
