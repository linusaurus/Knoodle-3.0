...
namespace FrameWorks.Makes.System5010
{
    ...
    public class FrameLS_XXO : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            //OTB_XXO
            part = new Part(5425, "OTB_XXO", this, 2, 0.0m);
            ...
            //Brz_XXO_OTB_EndCap -->> 
            part = new Part(4364, "Brz_XXO_OTB_EndCap", this, 2, 0.0m);
            part.PartGroupType = "Over_Travel";
            part.PartLabel = "";
            ...
            // QUAD SEAL
            part = new Part(4910, "Seal_at_Head", this, 2, 0.0m);
            part.PartGroupType = "Top_Seal";
            part.PartLabel = "";
            m_parts.Add(part);
