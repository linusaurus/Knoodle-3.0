...
namespace FrameWorks.Makes.System5010
{
    ...
    public class NailFinMiter : SubAssemblyBase
    {
        ...
        public NailFinMiter()
        {
            ...
            this.ModelID = "System5010-NailFinMiter";
        }
        ...
        public override void Build()
        {
            ...
            // NailerWidthExt
            part = new Part(4501, "NailerWidthExt", this, 2, m_subAssemblyWidth + nailFinAd * 2.0m);
            ...
            // NailerWidthExt
            part = new Part(4501, "NailerWidthExt", this, 2, m_subAssemblyDepth + nailFinAd * 2.0m);
            part.PartGroupType = "NailFin";
            part.PartLabel = "1)MiterEnds90°";
            m_parts.Add(part);
