...
namespace FrameWorks.Makes.System5010
{
    ...
    public class FrameLS_OXX : SubAssemblyBase
    {
        ...
        public FrameLS_OXX()
        {
            ...
            this.ModelID = "System5010-FrameLS_OXX";
        }
        ...
        public override void Build()
        {
            ...
            //OTB_OXX
            part = new Part(5426, "OTB_OXX", this, 2, 0.0m);
            ...
            //BzJamb -->> 
            part = new Part(4363, "BzJamb", this, 2, m_subAssemblyHieght - calkGap);
            ...
            //Brz_OXX_OTB_EndCap -->>            
            part = new Part(4364, "Brz_OXX_OTB_EndCap", this, 2, 0.0m);
            part.PartGroupType = "Over_Travel";
            part.PartLabel = "";
