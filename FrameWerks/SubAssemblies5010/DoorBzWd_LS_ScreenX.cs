...
namespace FrameWorks.Makes.System5010
{
    ...
    public class DoorBzWd_LS_ScreenX : SubAssemblyBase
    {
        ...
        public DoorBzWd_LS_ScreenX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System5010-DoorBzWd_LS_ScreenX";
        }
        ...
        public override void Build()
        {
            ...
            part = new Part(911, "LiftSlideGear", this, 1, m_subAssemblyHieght);
            ...
            if (m_subAssemblyHieght >= 104.0m)
            {
                ...
                part = new Part(911, "CoverExtension", this, c, 24.0m);
            ...
            part = new Part(911, "LockingBolts", this, 2, m_subAssemblyHieght);
            part.PartGroupType = "Hardware-Parts";
            part.PartLabel = "";
