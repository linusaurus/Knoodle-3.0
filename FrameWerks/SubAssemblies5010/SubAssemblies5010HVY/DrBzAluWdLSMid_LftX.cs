...
namespace FrameWorks.Makes.System5010HVY
{
    ...
    public class DrBzAluWdLSMid_LftX : SubAssemblyBase
    {
        ...
        public DrBzAluWdLSMid_LftX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System5010HVY-DrBzAluWdLSMid_LftX";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4554, "StileBZtbALLeft", this, 1, m_subAssemblyHieght);
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                part = new Part(4554, "StileBZtbALRight", this, 1, m_subAssemblyHieght);
                part.PartGroupType = "DoorBzAlTB-Parts";
                part.PartLabel = "1) Miter Ends";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                part = new Part(4554, "RailBZtbALtop", this, 1, m_subAssemblyWidth);
                part.PartGroupType = "DoorBzAlTB-Parts";
                part.PartLabel = "1) Miter Ends ";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                part = new Part(4554, "RailBZtbALbot", this, 1, m_subAssemblyWidth);
                part.PartGroupType = "DoorBzAlTB-Parts";
                part.PartLabel = "1) Miter Ends ";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                part = new Part(5397, "HDPE_LS_LockEdge1", this, 1, m_subAssemblyHieght);
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                part = new Part(5398, "HDPE_LS_LockEdge2", this, 1, m_subAssemblyHieght);
                part.PartGroupType = "HDPE-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = labelStileL = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(5527, "HDPE_LS_TopGuide", this, 1, topGuideHDPE);
                part.PartGroupType = "HDPE-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = labelStileL = "";
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(5469, "Alum_PVC_Corner_Bracket", this, 1, 0.0m);
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(5402, "TopGuide5402", this, 1, 0.0m);
                part.PartGroupType = "GuidesTop-Parts";
                part.PartLabel = "5402_HalfGearStile";
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(5400, "TopGuide5400", this, 1, 0.0m);
                part.PartGroupType = "GuidesTop-Parts";
                part.PartLabel = "5400_Overlap";
            ...
            part.PartLabel = "2.815_ThickDoor";
            ...
            part = new Part(4546, "EndCapMetal", this, 1, m_subAssemblyHieght + 0.0625m);
            part.PartGroupType = "HookCap-Parts";
            part.PartLabel = "ThickDoor";
