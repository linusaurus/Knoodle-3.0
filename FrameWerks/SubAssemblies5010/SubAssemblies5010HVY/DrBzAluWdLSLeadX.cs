    ...
    public class DrBzAluWdLSLeadX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                part = new Part(5398, "HDPE_LS_LockEdge1", this, 1, m_subAssemblyHieght);
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                part = new Part(5397, "HDPE_LS_LockEdge2", this, 1, m_subAssemblyHieght);
                part.PartGroupType = "HDPE-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = labelStileL = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(5527, "RootBlock", this, 1, 0.0m);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(5399, "HDPE_LS_TopGuide", this, 1, topGuideHDPE);
                part.PartGroupType = "HDPE-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = labelStileL = "";
