...
namespace FrameWorks.Makes.System5010HVY
{
    ...
    public class DrBzAluWdLSRerLftX : SubAssemblyBase
    {
        ...
        public DrBzAluWdLSRerLftX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System5010HVY-DrBzAluWdLSRerLftX";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(5214, "TopGuide5214", this, 1, 0.0m);
                part.PartGroupType = "GuidesTop-Parts";
                part.PartLabel = "5214_Overlap";
