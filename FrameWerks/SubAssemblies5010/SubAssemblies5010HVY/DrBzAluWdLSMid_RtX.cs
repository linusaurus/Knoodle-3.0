...
namespace FrameWorks.Makes.System5010HVY
{
    ...
    public class DrBzAluWdLSMid_RtX : SubAssemblyBase
    {
        ...
        public DrBzAluWdLSMid_RtX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System5010HVY-DrBzAluWdLSMid_RtX";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(4439, "TopGuide4439", this, 1, 0.0m);
                part.PartGroupType = "GuidesTop-Parts";
                part.PartLabel = "4439_HalfGearStile";
