...
namespace FrameWorks.Makes.System5010HVY
{
    ...
    public class DrBzAluWdLS_LftO : SubAssemblyBase
    {
        ...
        public DrBzAluWdLS_LftO()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System5010HVY-DrBzAluWdLS_LftO";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                part = new Part(5399, "TopGuide5399", this, 1, 0.0m);
                part.PartGroupType = "GuidesTop-Parts";
                part.PartLabel = "TopGuide5399";
