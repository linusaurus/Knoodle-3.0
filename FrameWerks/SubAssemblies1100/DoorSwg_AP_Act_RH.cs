    ...
    public class DoorSwg_AP_Act_RH : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                part = new Part(3400, "RailBot_", this, 1, m_subAssemblyWidth - doorReduceX2);
                part.PartGroupType = "AlumTB3.5inch";
                part.PartLabel = "1) Miter_Ends ";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3396, "AlumGlsStpVert||", this, 1, m_subAssemblyHieght - stopReduce - stopRedBot);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(3396, "AlumGlsStpTopBot^_", this, 1, m_subAssemblyWidth - stopReduceX2);
                part.PartGroupType = "StopAlum-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                part.PartGroupType = "AlumPanel-Parts";
                part.Qnty = 1;
