...
namespace FrameWorks.Makes.System1100
{
    ...
    public class DoorSwg_AP_Act_LH : SubAssemblyBase
    {
        ...
        const decimal glsDrGap = 3.875m;
        const decimal glsDrGapBot = 3.5625m;
        const decimal glsDrGapX2 = 3.875m * 2.0m;
        ...
        const decimal stopRedBot = 3.25m;
        const decimal stopReduce = 3.5625m;
        const decimal stopReduceX2 = 3.5625m * 2.0m;
        ...
        public DoorSwg_AP_Act_LH()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System1100-DoorSwg_AP_Act_LH";
        }
        ...
        public override void Build()
        {
            ...
            #region AlumTB3.5inch

            //////////////////////////////////////////////////////////////////////////////////////////////            

            // StileLeft
            part = new Part(3400, "StileLeft", this, 1, m_subAssemblyHieght - doorReduce - doorGapBot);
            part.PartGroupType = "AlumTB3.5inch";
            ...
            // StileRight
            part = new Part(3400, "StileRight", this, 1, m_subAssemblyHieght - doorReduce - doorGapBot);
            part.PartGroupType = "AlumTB3.5inch";
            part.PartLabel = "1) Miter_Ends";
            m_parts.Add(part);
            ...
            // RailTop
            part = new Part(3400, "RailTop", this, 1, m_subAssemblyWidth - doorReduceX2);
            part.PartGroupType = "AlumTB3.5inch";
            part.PartLabel = "1) Miter_Ends ";
            m_parts.Add(part);
            ...
            // RailBot
            part = new Part(3400, "RailBot", this, 1, m_subAssemblyWidth - doorReduceX2);
            part.PartGroupType = "AlumTB3.5inch";
            part.PartLabel = "1) Miter_Ends ";
            m_parts.Add(part);
            ...
            // AlumGlsStpLeft
            part = new Part(3396, "AlumGlsStpLeft", this, 1, m_subAssemblyHieght - stopReduce - stopRedBot);
            ...
            // AlumGlsStpRight
            part = new Part(3396, "AlumGlsStpRight", this, 1, m_subAssemblyHieght - stopReduce - stopRedBot);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumGlsStpTop
            part = new Part(3396, "AlumGlsStpTop", this, 1, m_subAssemblyWidth - stopReduceX2);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumGlsStpBot
            part = new Part(3396, "AlumGlsStpBot", this, 1, m_subAssemblyWidth - stopReduceX2);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumPanel
            part = new Part(911);
            part.FunctionalName = "AlumPanel";
            part.PartGroupType = "AlumPanel";
            part.Qnty = 1;
