...
namespace FrameWorks.Makes.System3000
{
    ...
    public class SlidingDoorMiddleXR : SubAssemblyBase
    {
        ...
        public SlidingDoorMiddleXR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "SlidingDoorMiddleXR";
        }
        ...
        public override void Build()
        {
            ...
            // Hooking Cap R -->>
            part = new Part(2157, "Hooking Cap R", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "Panel";
            part.PartLabel = "Machine Notch 0.50m";            
            m_parts.Add(part);

            // Plastic Hook Strip
            part = new Part(924, "Hook Strip", this, 2, m_subAssemblyHieght - 0.5m);
            part.PartGroupType = "Panel";
            part.PartLabel = "";            
            m_parts.Add(part);
            ...
            // Screws 
            part = new Part(1300, "Screws", this, Convert.ToInt32(((m_subAssemblyHieght / 4.0m) + 2.0m) * 2.0m), decimal.Zero);
            part.PartGroupType = "Hardware";
