...
namespace FrameWorks.Makes.System3000
{
    ...
    public class SlidingFrameOXX2D3 : SubAssemblyBase
    {
        ...
        public SlidingFrameOXX2D3()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "SlidingFrameOXX2D3";
        }
        ...
        public override void Build()
        {
           ...
           System3000.Helper.SliderOXXHelper helper = new System3000.Helper.SliderOXXHelper(3, 2, m_subAssemblyWidth);
            ...
            // SplitHead
            part = new Part(810, "SplitHead", this, 2, m_subAssemblyWidth + 0.03125m + 0.03125m  );
            part.PartGroupType = "Frame";
            part.PartLabel = "";            
            m_parts.Add(part);
            ...
            // EndCap
            part = new Part(2324, "EndCap", this, 2, 3.125m );
            part.PartGroupType = "Frame";
            part.PartLabel = "";            
            m_parts.Add(part);
