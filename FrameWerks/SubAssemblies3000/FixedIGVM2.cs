...
namespace FrameWorks.Makes.System3000
{
    ...
    public class FixedIGVM2 : SubAssemblyBase
    {
        ...
        public FixedIGVM2()
        {
            ...
            this.ModelID = "Sys3000-FixedIGVM2";
        }
        ...
        public override void Build()
        {
            ...
            // Muntin Bar ||
            part = new Part(1862, "Muntin Bars-V", this, 4, m_subAssemblyHieght - 2.0m * 1.375m);
            ...
            part = new Part(2808, "FoamTape", this, 4, m_subAssemblyHieght - 2.0m * 1.375m);
