...
namespace FrameWorks.Makes.System3000
{
    ...
    public class FixedIGDivV6 : SubAssemblyBase
    {
        ...
        public FixedIGDivV6()
        {
            ...
            this.ModelID = "Sys3000-FixedIGDivV6";
        }
        ...
        public override void Build()
        {
            ...
            // HStopBot
            string crap;
            crap = FrameWorks.Functions.StopWeepMachining(m_subAssemblyWidth - 0.0625m * 2.0m);
            part = new Part(809);
            part.Qnty = 1;
            part.PartGroupType = "Stop";
            part.ContainerAssembly = this;
            ...
            //GlassPanel1
            part = new Part(2828);
            part.FunctionalName = "GlassPanel1";
            part.PartGroupType = "Glass";
            part.Qnty = 1;
            part.PartName = "PartName";
            part.PartLabel = "";
            part.ContainerAssembly = this;
            part.PartWidth = (m_subAssemblyWidth - 3.125m) / 6.0m;
            part.PartLength = (m_subAssemblyHieght - (0.9375m * 2.0m));            
            m_parts.Add(part);

            //GlassPanel2
            part = new Part(2828);
            part.FunctionalName = "GlassPanel2";
            part.PartGroupType = "Glass";
            part.Qnty = 1;
            part.PartName = "PartName";
            part.PartLabel = "";
            ...
            //GlassPanel3
            part = new Part(2828);
            part.FunctionalName = "GlassPanel3";
            part.PartGroupType = "Glass";
            part.Qnty = 1;
            part.PartName = "PartName";
            part.PartLabel = "";
            ...
            //GlassPanel4
            part = new Part(2828);
            part.FunctionalName = "GlassPanel4";
            part.PartGroupType = "Glass";
            part.Qnty = 1;
            part.PartName = "PartName";
            part.PartLabel = "";
            ...
            //GlassPanel5
            part = new Part(2828);
            part.FunctionalName = "GlassPanel5";
            part.PartGroupType = "Glass";
            part.Qnty = 1;
            part.PartName = "PartName";
            part.PartLabel = "";
            ...
            //GlassPanel6
            part = new Part(2828);
            part.FunctionalName = "GlassPanel6";
            part.PartGroupType = "Glass";
            part.Qnty = 1;
            part.PartName = "PartName";
            part.PartLabel = "";
