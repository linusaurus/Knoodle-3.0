    ...
    public class DoorTrans1x2Pair : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                // JambAlum ^^
                part = new Part(4352, "JambsAlum", this, 1, m_subAssemblyHieght);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4352, "HeadSillAlum", this, 1, m_subAssemblyWidth);
                part.PartGroupType = "Frame-Parts";
                part.PartLabel = "1)MiterEnds";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(5060, "HDPELockEdge", this, 1, m_subAssemblyHieght + hdpExtnd);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(5060, "HDPETop", this, 1, (m_subAssemblyWidth - doorReduceX2 - doorGapMid + hdpExtX2) / 2.0m);
                part.PartGroupType = "HDPE-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(5060, "HDPEBot", this, 1, (m_subAssemblyWidth - doorReduceX2 - doorGapMid + hdpExtX2) / 2.0m);
                part.PartGroupType = "HDPE-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = labelStileR = "";
