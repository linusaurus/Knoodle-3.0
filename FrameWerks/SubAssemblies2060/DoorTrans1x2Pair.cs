...
namespace FrameWorks.Makes.System2060
{
    ...
    public class DoorTrans1x2Pair : SubAssemblyBase
    {
        ...
        public DoorTrans1x2Pair()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2060-DoorTrans1x2Pair";
        }
        ...
        public override void Build()
        {
            ...
            // AlumHead ^^
            part = new Part(4352, "AlumHead", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "1)MiterEnds";
            m_parts.Add(part);
            ...
            // AlumSill ||
            part = new Part(4352, "AlumSill", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "1)MiterEnds";
            m_parts.Add(part);
            ...
            // PVC ASTRAGAL
            part = new Part(1901, "PVC ASTRAGAL", this, 1, m_subAssemblyHieght - headReduct - headReduct);
            ...
            // ASTRAGAL_COVER
            part = new Part(4496, "ASTRAGAL_COVER", this, 1, m_subAssemblyHieght - headReduct - headReduct);
            part.PartGroupType = "HardWare-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(5131, "StileLeft", this, 1, m_subAssemblyHieght - doorReduce - doorReduce);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(5131, "StileRight", this, 1, m_subAssemblyHieght - doorReduce - doorReduce);
                part.PartGroupType = "AlumTB3inch";
                part.PartLabel = "1) Miter_Ends";
                m_parts.Add(part);
            }
            ...
            // HDPELockEdge
            part = new Part(5060, "HDPELockEdge", this, 2, m_subAssemblyHieght + hdpExtnd);
            ...
            // HDPEHingEdge
            part = new Part(5060, "HDPEHingEdge", this, 2, m_subAssemblyHieght + hdpExtnd);
            part.PartGroupType = "HDPE-Parts";
            part.PartLabel = labelStileL = "";
            m_parts.Add(part);
            ...
            // HDPETop
            part = new Part(5060, "HDPETop", this, 2, (m_subAssemblyWidth - doorReduceX2 - doorGapMid + hdpExtX2) / 2.0m);
            part.PartGroupType = "HDPE-Parts";
            ...
            // HDPEBot
            part = new Part(5060, "HDPEBot", this, 2, (m_subAssemblyWidth - doorReduceX2 - doorGapMid + hdpExtX2) / 2.0m);
            part.PartGroupType = "HDPE-Parts";
            part.PartLabel = labelStileR = "";
            m_parts.Add(part);
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(5306, "MuntVert", this, 1, m_subAssemblyHieght - topMuntGp - topMuntGp);
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(5123, "AlumGlsStpVert", this, 1, m_subAssemblyHieght - stopReduce - stopReduce);
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(2772, "EPDM_Wedge_Munt_INT", this, 1, m_subAssemblyHieght - topMuntGp - topMuntGp);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(5557, "EPDM_Wedge_Munt_EXT", this, 1, m_subAssemblyHieght - topMuntGp - topMuntGp);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
                m_parts.Add(part);
            }
