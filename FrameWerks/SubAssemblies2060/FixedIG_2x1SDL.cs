...
namespace FrameWorks.Makes.System2060
{
    ...
    public class FixedIG_2x1SDL : SubAssemblyBase
    {
        ...
        const decimal muntReduceX2 = .6250m * 2.0m;
        ...
        public FixedIG_2x1SDL()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2060-FixedIG_2x1SDL";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(5306, "MuntVert", this, 1, m_subAssemblyHieght - muntReduceX2 );
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(2772, "EPDM_Wedge_Munt_INT", this, 1, m_subAssemblyHieght - muntReduceX2 / 2.0m);
                part.PartGroupType = "GlazingSeal";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(5557, "EPDM_Wedge_Munt_EXT", this, 1, m_subAssemblyHieght - muntReduceX2 / 2.0m);
                part.PartGroupType = "GlazingSeal";
                part.PartLabel = "";
                m_parts.Add(part);
            }
