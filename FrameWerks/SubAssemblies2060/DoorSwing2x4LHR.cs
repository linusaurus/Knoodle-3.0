...
namespace FrameWorks.Makes.System2060
{
    ...
    public class DoorSwing2x4LHR : SubAssemblyBase
    {
        ...
        const decimal MuntGap = 3.125m;
        const decimal MuntGapX2 = 3.125m * 2.0m;
        const decimal MuntGapBot = 3.0m;
        ...
        public DoorSwing2x4LHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2060-DoorSwing2x4LHR";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                part = new Part(5306, "MuntVert", this, 1, (m_subAssemblyHieght - MuntGap - MuntGapBot) / 4.0m);
                part.PartGroupType = "Muntins";
                part.PartLabel = "?_Ends";
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                part = new Part(2772, "EPDM_Wedge_Munt_INT", this, 1, (m_subAssemblyHieght - MuntGap - MuntGapBot) / 4.0m);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                part = new Part(5557, "EPDM_Wedge_Munt_EXT", this, 1, (m_subAssemblyHieght - MuntGap - MuntGapBot) / 4.0m);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
