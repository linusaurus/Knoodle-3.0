...
namespace FrameWorks.Makes.System2060
{
    ...
    public class DoorSwg_AP_Act_RH : SubAssemblyBase
    {
        ...
        public DoorSwg_AP_Act_RH()
        {
            ...
            this.ModelID = "System2060-DoorSwg_AP_Act_RH";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4341, "AlumGlsStpTopBot^_", this, 1, m_subAssemblyWidth - stopReduceX2);
                part.PartGroupType = "StopAlum-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = "";
            ...
            // SS_0.4662_InsetCrnBrace 
            for (int i = 0; i < 4; i++)
            {
                part = new Part(4784, "SS_0.4662_InsetCrnBrace", this, 1, 0.0m);
