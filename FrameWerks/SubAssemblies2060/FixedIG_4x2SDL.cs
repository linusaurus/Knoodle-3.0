...
namespace FrameWorks.Makes.System2060
{
    ...
    public class FixedIG_4x2SDL : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                part = new Part(5267, "CrossBrace4X2", this, 1, 0);
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                part = new Part(2772, "EPDM_Wedge_Munt_INT", this, 1, m_subAssemblyWidth - MuntGapX2 / 4.0m);
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                part = new Part(5557, "EPDM_Wedge_Munt_EXT", this, 1, m_subAssemblyWidth - MuntGapX2 / 4.0m);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
            ...
            for (int i = 0; i < 12; i++)
            {
                ...
                part = new Part(2772, "EPDM_Wedge", this, 1, m_subAssemblyHieght - MuntGapX2 / 2.0m);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
