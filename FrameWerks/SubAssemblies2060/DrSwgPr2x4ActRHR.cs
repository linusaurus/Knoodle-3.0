    ...
    public class DrSwgPr2x4ActRHR : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(5536, "HDPEHingEdgeSHIM_0.3125", this, 1, m_subAssemblyHieght + hdpExtnd);
                part.PartGroupType = "HDPE-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = labelStileL = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(5537, "HDPETop", this, 1, (m_subAssemblyWidth - doorReduceX2 - doorGapMid + hdpExtX2) / 2.0m);
                part.PartGroupType = "HDPE-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(5538, "HDPE_Shim_0.218", this, 1, (m_subAssemblyWidth - doorReduceX2 - doorGapMid + hdpExtX2) / 2.0m);
                part.PartGroupType = "HDPE-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = labelStileR = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(5539, "HDPEBot", this, 1, (m_subAssemblyWidth - doorReduceX2 - doorGapMid + hdpExtX2) / 2.0m);
                part.PartGroupType = "HDPE-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = labelStileR = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(5538, "HDPEBot_Shim_0.218", this, 1, (m_subAssemblyWidth - doorReduceX2 - doorGapMid + hdpExtX2) / 2.0m);
                part.PartGroupType = "HDPE-Parts";
                part.PartWidth = part.Source.Width;
                part.PartThick = part.Source.Height;
                part.PartLabel = labelStileR = "";
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                part = new Part(2227, "EPDM_Wedge_Munt_INT", this, 1, (m_subAssemblyHieght - topMuntGp - botMuntGp) / 4.0m);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
