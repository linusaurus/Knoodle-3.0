...
namespace FrameWorks.Makes.System2060
{
    ...
    public class DrSwgPr2x4ActRHR : SubAssemblyBase
    {
        ...
        public DrSwgPr2x4ActRHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2060-DrSwgPr2x4ActRHR";
        }
        ...
        public override void Build()
        {
            ...
            // HDPELockEdge
            part = new Part(5537, "HDPELockEdge", this, 2, m_subAssemblyHieght);
            ...
            // HDPE_Shim_0.218
            part = new Part(5538, "HDPE_Shim_0.218", this, 2, m_subAssemblyHieght);
            part.PartGroupType = "HDPE";
            part.PartLabel = labelStileL = "";
            m_parts.Add(part);
            ...
            // HDPEHingEdgeSHIM_0.3125
            part = new Part(5536, "HDPEHingEdgeSHIM_0.3125", this, 2, m_subAssemblyHieght + hdpExtnd);
            part.PartGroupType = "HDPE";
            part.PartLabel = labelStileL = "";
            m_parts.Add(part);
            ...
            // HDPETop
            part = new Part(5537, "HDPETop", this, 2, (m_subAssemblyWidth - doorReduceX2 - doorGapMid + hdpExtX2) / 2.0m);
            part.PartGroupType = "HDPE";
            ...
            // HDPE_Shim_0.218
            part = new Part(5538, "HDPE_Shim_0.218", this, 2, (m_subAssemblyWidth - doorReduceX2 - doorGapMid + hdpExtX2) / 2.0m);
            part.PartGroupType = "HDPE";
            part.PartLabel = labelStileR = "";
            m_parts.Add(part);
            ...
            // HDPEBot
            part = new Part(5539, "HDPEBot", this, 2, (m_subAssemblyWidth - doorReduceX2 - doorGapMid + hdpExtX2) / 2.0m);
            part.PartGroupType = "HDPE";
            part.PartLabel = labelStileR = "";
            m_parts.Add(part);
            ...
            // HDPEBot_Shim_0.218
            part = new Part(5538, "HDPEBot_Shim_0.218", this, 2, (m_subAssemblyWidth - doorReduceX2 - doorGapMid + hdpExtX2) / 2.0m);
            part.PartGroupType = "HDPE";
            part.PartLabel = labelStileR = "";
            m_parts.Add(part);
            ...
            // AlumGlsStpLeft
            part = new Part(5123, "AlumGlsStpLeft", this, 1, m_subAssemblyHieght - stopReduce - stopRedBot);
            ...
            // AlumGlsStpRight
            part = new Part(5123, "AlumGlsStpRight", this, 1, m_subAssemblyHieght - stopReduce - stopRedBot);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumGlsStpTop
            part = new Part(5123, "AlumGlsStpTop", this, 1, (m_subAssemblyWidth - stopRed2x - stopRedMid) / 2.0m);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumGlsStpBot
            part = new Part(5123, "AlumGlsStpBot", this, 1, (m_subAssemblyWidth - stopRed2x - stopRedMid) / 2.0m);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // StrikePlateLH_RHR 
            part = new Part(5339, "StrikePlateLH_RHR ", this, 1, 0.0m);
            part.PartGroupType = "Hardware";
            part.PartLabel = "";
            m_parts.Add(part);
