...
namespace FrameWorks.Makes.System2060
{
    ...
    public class Awning2x2 : SubAssemblyBase
    {
        ...
        const decimal MuntinGapX2 = 1.875m * 2.0m;
        ...
        public Awning2x2()
        {
            ...
            this.ModelID = "System2060-Awning2x2";
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(5306, "MuntHorz", this, 1, (m_subAssemblyWidth - MuntinGapX2) / 2.0m);
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(5306, "MuntVert", this, 1, (m_subAssemblyHieght - MuntinGapX2) / 2.0m);
                part.PartGroupType = "Muntins";
                part.PartLabel = "?_Ends";
                m_parts.Add(part);
            }
            ...
            //CrossBrace2X2
            part = new Part(5267, "Cross_Bracket", this, 2, 0);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(5123, "AlumGlsStpVt", this, 1, m_subAssemblyHieght - gstopReduce2X);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(5123, "AlumGlsStpHz", this, 1, m_subAssemblyWidth - gstopReduce2X);
                part.PartGroupType = "StopAlum-Parts";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(5557, "EPDM_Wedge_Munt_EXT", this, 1, (m_subAssemblyWidth - MuntinGapX2) / 2.0m);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(2772, "EPDM_Wedge_Munt_INT", this, 1, (m_subAssemblyWidth - MuntinGapX2) / 2.0m);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(5557, "EPDM_Wedge_Munt_EXT", this, 1, (m_subAssemblyHieght - MuntinGapX2) / 2.0m);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(2772, "EPDM_Wedge_Munt_INT", this, 1, (m_subAssemblyHieght - MuntinGapX2) / 2.0m);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
                m_parts.Add(part);
            }
