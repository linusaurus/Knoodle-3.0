...
namespace FrameWorks.Makes.System2060
{
    ...
    public class Awning1x4 : SubAssemblyBase
    {
        ...
        public Awning1x4()
        {
            ...
            this.ModelID = "System2060-Awning1x4";
        ...
        public override void Build()
        {
            ...
            // TruthMaxim24Lock
            part = new Part(4911, "TruthSeries24Locks", this, 2, 0m);
            part.PartGroupType = "OperHardware-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // Keeper
            part = new Part(3516, "Keepers", this, 2, 0m);
            part.PartGroupType = "OperHardware-Parts";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            for (int i = 0; i < 6; i++)
            {
                part = new Part(5306, "MuntHorz", this, 1, (m_subAssemblyWidth - MuntinGapX2));
            ...
            for (int i = 0; i < 6; i++)
            {
                part = new Part(5557, "EPDM_Wedge_Munt_EXT", this, 1, (m_subAssemblyWidth - MuntinGapX2));
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 6; i++)
            {
                part = new Part(2772, "EPDM_Wedge_Munt_INT", this, 1, (m_subAssemblyWidth - MuntinGapX2));
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
                m_parts.Add(part);
            }
