...
namespace FrameWorks.Makes.System2060
{
    ...
    public class DrAl_LS_Mid_2x4_LftX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // TopGuide5622
            part = new Part(5622, "TopGuide5622", this, 2, 0.0m);
            part.PartGroupType = "GuidesTop-Parts";
            ...
            for (int i = 0; i < 12; i++)
            {
                part = new Part(2772, "EPDM_Wedge_Munt_INT", this, 11, (m_subAssemblyWidth - sidMuntGap2) / 2.0m);
                part.PartGroupType = "Seal-Parts";
                part.PartLabel = "";
                m_parts.Add(part);
            }
