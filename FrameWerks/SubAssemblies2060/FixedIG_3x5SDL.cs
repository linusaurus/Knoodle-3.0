...
namespace FrameWorks.Makes.System2060
{
    ...
    public class FixedIG_3x5SDL : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                part = new Part(5306, "MuntVert", this, 1, (m_subAssemblyHieght ) / 4.0m);
                part.PartGroupType = "Muntins";
                part.PartLabel = "?_Ends";
                m_parts.Add(part);
            }
            ...
            //CrossBrace3X5
            part = new Part(5267, "CrossBrace3X5", this, 16, 0);
            ...
            //SetScrew_10_32
            part = new Part(3518, "SetScrew_10_32", this, 128, PointSetScrew);
            part.PartGroupType = "AssyBrackets";
            ...
            for (int i = 0; i < 24; i++)
            {
                part = new Part(2772, "EPDM_Wedge_Munt_INT", this, 1, m_subAssemblyWidth - MuntGapX2 / 3.0m);
            ...
            for (int i = 0; i < 24; i++)
            {
                part = new Part(5557, "EPDM_Wedge_Munt_EXT", this, 1, m_subAssemblyWidth - MuntGapX2 / 3.0m);
                part.PartGroupType = "Seal";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 16; i++)
            {
                part = new Part(2772, "EPDM_Wedge_Munt_INT", this, 1, m_subAssemblyHieght - MuntGapX2 / 5.0m);
                part.PartGroupType = "Seal";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            for (int i = 0; i < 16; i++)
            {
                part = new Part(5557, "EPDM_Wedge_Munt_EXT", this, 1, m_subAssemblyHieght - MuntGapX2 / 5.0m);
                part.PartGroupType = "Seal";
                part.PartLabel = "";
                m_parts.Add(part);
            }
