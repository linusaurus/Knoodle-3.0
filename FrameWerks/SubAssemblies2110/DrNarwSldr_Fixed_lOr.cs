...
namespace FrameWorks.Makes.System2110
{
    ...
    public class DrNarwSldr_Fixed_lOr : SubAssemblyBase
    {
        ...
        public DrNarwSldr_Fixed_lOr()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-DrNarwSldr_Fixed_lOr";
        }
        ...
        public override void Build()
        {
            ...
            // HDPE1
            part = new Part(6961, "HDPE1", this, 1, m_subAssemblyHieght + 0.0625m);
            ...
            // HDPE2
            part = new Part(6961, "HDPE2", this, 1, m_subAssemblyHieght + 0.0625m);
            part.PartGroupType = "HookCap";
            part.PartWidth = part.Source.Width = 2.1315m;
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // EdgeCap1
            part = new Part(3623, "EdgeCap1", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "HookCap";
            part.PartLabel = "";
            m_parts.Add(part);

            // EdgeCap2
            part = new Part(3623, "EdgeCap2", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "HookCap";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // HookStrip2
            part = new Part(3710, "HookStrip2", this, 1, m_subAssemblyHieght + 0.0625m);
            part.PartGroupType = "HookCap";
            part.PartWidth = part.Source.Width = 1.3411m;
            part.PartLabel = "CutWidthTo_1.3411";
            m_parts.Add(part);
