...
namespace FrameWorks.Makes.System2110
{
    ...
    public class Frame_NrwFLSash_XXXO : SubAssemblyBase
    {
        ...
        const decimal edgeCap1X = 0.125m;
        const decimal edgeCap2X = 2.0m * 0.125m;
        const decimal splitHdOTB_add = 3.75m;
        const decimal splitHdOTB_Red = 5.71875m;
        const decimal splitMidDrED = 1.21875m;
        ...
        public Frame_NrwFLSash_XXXO()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-Frame_NrwFLSash_XXXO";
        }
        ...
        public override void Build()
        {
            ...
            // Top22mmTrackXXXO
            part = new Part(4447, "Top22mmTrackXXXO", this, 1, (trackHelper.DoorPanelWidth * 4.0m) - stileOvrLpX3 + doorGap);
            ...
            // Top22mmTrackXXO
            part = new Part(4447, "Top22mmTrackXXO", this, 1, (trackHelper.DoorPanelWidth * 3.0m) - stileOvrLpX2 + edgeCap1X + yTrAccess);
            part.PartGroupType = "TopTrackY";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // Top22mmTrackXO
            part = new Part(4447, "Top22mmTrackXO", this, 1, (trackHelper.DoorPanelWidth * 2.0m) - stileOverLap + edgeCap1X + yTrAccess);
            part.PartGroupType = "TopTrackY";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // Top22mmTrackO
            part = new Part(4447, "Top22mmTrackO", this, 1, (trackHelper.DoorPanelWidth) + doorGap + edgeCap1X + yTrAccess);
            part.PartGroupType = "TopTrackY";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            //ShapedYtrackRubbers -->> 
            part = new Part(4447, "ShapedYtrackRubbers", this, 6, 0.0m);
            part.PartGroupType = "TopTrackY";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            //OTB_XO_XP
            part = new Part(6878, "OTB_XO_XP", this, 3, 0.0m);
            ...
            // SplitHeadInt ^^
            part = new Part(4362, "SplitHeadInt", this, 1, m_subAssemblyWidth - jambDimW2X + jambInset);
            part.PartGroupType = "Frame";
            ...
            // SplitHeadExtXXX ^^
            part = new Part(4362, "SplitHeadExtXXX", this, 1, trackHelper.DoorPanelWidth - splitMidDrED);
            part.PartGroupType = "Frame";
            part.PartLabel = "Cut_1.875";
            m_parts.Add(part);
            ...
            // SplitHeadExtXX ^^
            part = new Part(4362, "SplitHeadExtXX", this, 1, trackHelper.DoorPanelWidth - splitMidDrED);
            part.PartGroupType = "Frame";
            part.PartLabel = "Cut_1.875";
            m_parts.Add(part);
            ...
            // SplitHeadExtX ^^
            part = new Part(4362, "SplitHeadExtX", this, 1, trackHelper.DoorPanelWidth - jambInset - splitHdOTB_Red);
            part.PartGroupType = "Frames";
            part.PartLabel = "Cut_1.875";
            m_parts.Add(part);
            ...
            // Pile_Seals ^^
            part = new Part(3979, "Pile_Seals", this, 1, m_subAssemblyWidth - jambDimW2X + jambInset);
            part.PartGroupType = "Pile_Seals";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // Pile_Seals ^^
            part = new Part(3979, "Pile_Seals", this, 2, trackHelper.DoorPanelWidth - splitMidDrED);
            part.PartGroupType = "Pile_Seals";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // Pile_Seals ^^
            part = new Part(3979, "Pile_Seals", this, 1, trackHelper.DoorPanelWidth - jambInset - splitHdOTB_Red);
            part.PartGroupType = "Pile_Seals";
            part.PartLabel = "";
            m_parts.Add(part);
