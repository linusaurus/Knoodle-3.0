...
namespace FrameWorks.Makes.System2110
{
    ...
    public class Frame_NrwSash_OXXX : SubAssemblyBase
    {
        ...
        const decimal splitHdOTB_add = 4.125m;
        ...
        public Frame_NrwSash_OXXX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-Frame_NrwSash_OXXX";
        }
        ...
        public override void Build()
        {
            ...
            // OTB_OX_PX
            part = new Part(6876, "OTB_OX_PX", this, 3, 0.0m);
