...
namespace FrameWorks.Makes.System2110
{
    ...
    public class FrameE4BiFold : SubAssemblyBase
    {
        ...
        public FrameE4BiFold()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-FrameE4BiFold";
        }
        ...
        public override void Build()
        {
            ...
            // BiFoildBtmTrack ^^
            part = new Part(5702, "BiFoildBtmTrack", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "BiFoldTrack";
            part.PartLabel = "Bottom";
            m_parts.Add(part);

            // BiFoldTopTrack ^^
            part = new Part(3718, "BiFoldTopTrack", this, 1, m_subAssemblyWidth);
            part.PartGroupType = "BiFoldTrack";
            part.PartLabel = "Top";
            m_parts.Add(part);
