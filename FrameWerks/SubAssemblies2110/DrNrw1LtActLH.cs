...
namespace FrameWorks.Makes.System2110
{
    ...
    public class DrNrw1LtActLH : SubAssemblyBase
    {
        ...
        public DrNrw1LtActLH()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-DrNrw1LtActLH";
        }
        ...
        public override void Build()
        {
            ...
            // AluGlsStopT ^^
            part = new Part(5711, "AluGlsStopT", this, 1, m_subAssemblyWidth - stopReduceX2);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AluGlsStopB ||
            part = new Part(5711, "AluGlsStopB", this, 1, m_subAssemblyWidth - stopReduceX2);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
