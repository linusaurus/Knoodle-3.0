...
namespace FrameWorks.Makes.System2110Maxim
{
    ...
    public class CaseUnitRHR : SubAssemblyBase
    {
        ...
        public CaseUnitRHR()
        {
            ...
            this.ModelID = "System2110Maxim-CaseUnitRHR";
        }
        ...
        public override void Build()
        {
            ...
            // TangoHndlCovRH
            part = new Part(4938, "TangoHndlCovRH", this, 1, 0.0m);
            ...
            // HingeCaseUR
            part = new Part(995, "HingeCaseUR", this, 1, 0.0m);
            ...
            // HingeCaseLR
            part = new Part(996, "HingeCaseLR", this, 1, 0.0m);
            part.PartGroupType = "Hardware";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // HingeSpacer
            part = new Part(219, "HingeSpacer", this, 2, 0.0m);
            part.PartGroupType = "Hardware";
