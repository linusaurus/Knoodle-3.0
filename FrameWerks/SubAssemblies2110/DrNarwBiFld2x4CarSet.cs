...
namespace FrameWorks.Makes.System2110
{
    ...
    public class DrNarwBiFld2x4CarSet : SubAssemblyBase
    {
        ...
        public DrNarwBiFld2x4CarSet()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-DrNarwBiFld2x4CarSet";
        }
        ...
        public override void Build()
        {
            ...
            // HardwareBO
            part = new Part(5710, "Handle_BumpOut", this, 1, 0.0m);
            part.PartGroupType = "HardwareBO";
            part.PartLength = 29.8906m;
            part.PartLabel = "";
            m_parts.Add(part); ;
            ...
            // AlumGlsStopBO
            part = new Part(5711, "AlumGlsStopBO", this, 1, 0.0m );
            part.PartGroupType = "HardwareBO";
            part.PartLength = 29.8906m;
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // AlumGlsStopBORT
            part = new Part(5711, "AlumGlsStopBORT", this, 2, 0.0m);
            part.PartGroupType = "HardwareBO";
            part.PartLength = 2.4063m;
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            //Glass
            part = new Part(5785);
            part.FunctionalName = "Glass_2x4_SDL+BO";
            part.PartGroupType = "Glass_2x4_SDL+BO";
            part.Qnty = 1;
            ...
            // E4_IterMed_CarrierSet
            part = new Part(3720, "E4_IterMed_CarrierSet", this, 1, 0.0m);
            ...
            // Edge_Seal
            part = new Part(2274, "Edge_Seal", this, 3, m_subAssemblyHieght);
            part.PartGroupType = "Seal";
            part.PartLabel = "";
            m_parts.Add(part);
