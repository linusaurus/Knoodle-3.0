...
namespace FrameWorks.Makes.System2110
{
    ...
    public class Frame_NrwSash_OX : SubAssemblyBase
    {
        ...
        public Frame_NrwSash_OX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-Frame_NrwSash_OX";
        }
        ...
        public override void Build()
        {
            ...
            // Pile_Seals ^^
            part = new Part(3979, "Pile_Seals", this, 1, (trackHelper.DoorPanelWidth - stileCut) - splitHdOTB_Red - jambInset);
            part.PartGroupType = "Pile_Seals";
            part.PartLabel = "";
            m_parts.Add(part);
