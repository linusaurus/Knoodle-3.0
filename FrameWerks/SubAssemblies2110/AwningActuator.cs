...
namespace FrameWorks.Makes.System2110
{
    ...
    public class AwningActuator : SubAssemblyBase
    {
        ...
        public AwningActuator()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-AwningActuator";
        ...
        public override void Build()
        {
            ...
            // LM/2_Actuator
            part = new Part(3765, "LM/2_Actuator", this, 1, 0.0m);
            ...
            // AlumGlsStopT ^^
            part = new Part(5711, "AlumGlsStpHz", this, 1, m_subAssemblyWidth - gstopReduce2X);
            part.PartGroupType = "StopAlum";
            part.PartLabel = "";
            m_parts.Add(part);
