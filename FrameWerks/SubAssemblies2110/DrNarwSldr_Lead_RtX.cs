...
namespace FrameWorks.Makes.System2110
{
    ...
    public class DrNarwSldr_Lead_RtX : SubAssemblyBase
    {
        ...
        public DrNarwSldr_Lead_RtX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-DrNarwSldr_Lead_RtX";
        }
        ...
        public override void Build()
        {
            ...
            part.PartGroupType = "HookCap";
            part.PartWidth = part.Source.Width = 2.7362m;
            part.PartLabel = "";
            m_parts.Add(part);
