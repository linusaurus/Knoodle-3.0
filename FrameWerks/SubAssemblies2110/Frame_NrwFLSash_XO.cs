...
namespace FrameWorks.Makes.System2110
{
    ...
    public class Frame_NrwFLSash_XO : SubAssemblyBase
    {
        ...
        public Frame_NrwFLSash_XO()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-Frame_NrwFLSash_XO";
        }
        ...
        public override void Build()
        {
            ...
            // Top22mmTrackO
            part = new Part(4447, "Top22mmTrackO", this, 1, trackHelper.DoorPanelWidth + doorGap + yTrack);
            part.PartGroupType = "TopTrackY";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // SplitHeadExtO ^^
            part = new Part(4362, "SplitHeadExtO", this, 1, trackHelper.DoorPanelWidth - jambInset + splitHdOTB_add);
            part.PartGroupType = "Frame";
            part.PartLabel = "Cut_1.875";
            m_parts.Add(part);
