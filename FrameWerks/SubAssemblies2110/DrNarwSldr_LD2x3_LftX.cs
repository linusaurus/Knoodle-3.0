...
namespace FrameWorks.Makes.System2110
{
    ...
    public class DrNarwSldr_LD2x3_LftX : SubAssemblyBase
    {
        ...
        public DrNarwSldr_LD2x3_LftX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-DrNarwSldr_LD2x3_LftX";
        }
        ...
        public override void Build()
        {
            ...
            // MuntinBar2
            part = new Part(6924, "MuntinBar2", this, 1, m_subAssemblyWidth - muntinReduce2X);
            part.PartGroupType = "MuntinBar2";
            part.PartLabel = "Horz";
            part.PartWidth = 1.0m;
            m_parts.Add(part);
