...
namespace FrameWorks.Makes.System2110
{
    ...
    public class DrNarwSldr_Mid_RtX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // HDPE
            part = new Part(6961, "HDPE", this, 2, m_subAssemblyHieght + 0.0625m);
            ...
            // EdgeCap
            part = new Part(3623, "EdgeCap", this, 2, m_subAssemblyHieght);
            part.PartGroupType = "HookCap";
            part.PartLabel = "";
            m_parts.Add(part);
