...
namespace FrameWorks.Makes.System2110
{
    ...
    public class Frame_NrwSash_XXO : SubAssemblyBase
    {
        ...
        public Frame_NrwSash_XXO()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-Frame_NrwSash_XXO";
        }
        ...
        public override void Build()
        {
            ...
            // Top22mmTrackO
            part = new Part(4447, "Top22mmTrackO", this, 1, (trackHelper.DoorPanelWidth * 3.0m) - stileOvrLpX2 + doorGap);
            ...
            // Top22mmTrack_XO
            part = new Part(4447, "Top22mmTrack_XO", this, 1, (trackHelper.DoorPanelWidth * 2.0m) - stileOverLap - stileCut + edgeCap1X + yTrAccess);
            part.PartGroupType = "TopTrackY";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            // Top22mmTrack__O
            part = new Part(4447, "Top22mmTrack__O", this, 1, (trackHelper.DoorPanelWidth) - stileCut + edgeCap1X + doorGap + yTrAccess);
            part.PartGroupType = "TopTrackY";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            //OTB_XO_XP
            part = new Part(6878, "OTB_XO_XP", this, 2, 0.0m);
            ...
            // SplitHeadExtO ^^
            part = new Part(4362, "SplitHeadExtO", this, 1, trackHelper.DoorPanelWidth - stileCut - jambInset + edgeCap1X + doorGap + splitHdOTB_add);
            part.PartGroupType = "Frame";
            part.PartLabel = "Cut_1.875";
            m_parts.Add(part);
