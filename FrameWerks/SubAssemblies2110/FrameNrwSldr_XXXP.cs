...
namespace FrameWorks.Makes.System2110
{
    ...
    public class FrameNrwSldrXXXP : SubAssemblyBase
    {
        ...
        public FrameNrwSldrXXXP()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-FrameNrwSldrXXXP";
        }
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                part = new Part(4447, "Top22mmTrackXXXP", this, 1, (trackHelper.DoorPanelWidth * 4.0m) - stileOvrLpX2 + doorGap);
            ...
            for (int i = 0; i < 3; i++)
            {
                part = new Part(4730, "Bronze_HemoXXXP", this, 1, (trackHelper.DoorPanelWidth * 4.0m) - stileOvrLpX2 + doorGap);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4357, "SplitJambPocket", this, 1, m_subAssemblyHieght - calkGap);
