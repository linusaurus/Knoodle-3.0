...
namespace FrameWorks.Makes.System2110
{
    ...
    public class DrNrw1LtPassLH : SubAssemblyBase
    {
        ...
        public DrNrw1LtPassLH()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-DrNrw1LtPassLH";
        }
        ...
        public override void Build()
        {
            ...
            // BackerHinge
            part = new Part(911, "BackerHinge", this, HingeCount(m_subAssemblyHieght), 0.0m);
            part.PartGroupType = "Hardware";
            part.PartLabel = "";
            m_parts.Add(part);
