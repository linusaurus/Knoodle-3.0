...
namespace FrameWorks.Makes.System2110
{
    ...
    public class DrFrm4Sd : SubAssemblyBase
    {
        ...
        public DrFrm4Sd()
        {
            ...
            this.ModelID = "System2110-DrFrm4Sd";
        }
        ...
        public override void Build()
        {
            ...
            // JmbAlumR -->>
            part = new Part(4352, "JmbAlumR", this, 1, m_subAssemblyHieght);
            ...
            // JmbAlumL <<-- 
            part = new Part(4352, "JmbAlumL", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "Frame";
            part.PartLabel = "1)MiterEnds";
            m_parts.Add(part);
