...
namespace FrameWorks.Makes.System2110
{
    ...
    public class DrNrw1x3KpActRH : SubAssemblyBase
    {
        ...
        const decimal glsDrGap = 1.0625m;
        const decimal glsDrGapX2 = 2.0m * 1.0625m;
        const decimal glsBotRailGap = 11.15625m;
        ...
        const decimal panelCoreRed2X = 0.7787m * 2.0m;
        ...
        public DrNrw1x3KpActRH()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-DrNrw1x3KpActRH";
        }
