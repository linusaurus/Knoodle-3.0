...
namespace FrameWorks.Makes.System2110
{
    ...
    public class DrNrw1LtActRH : SubAssemblyBase
    {
        ...
        public DrNrw1LtActRH()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-DrNrw1LtActRH";
        }
        ...
        public override void Build()
        {
            ...
            // HDPELockEdge1
            part = new Part(6879, "HDPELockEdge1", this, 1, m_subAssemblyHieght);
