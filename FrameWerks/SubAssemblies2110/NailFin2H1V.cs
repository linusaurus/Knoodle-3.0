...
{
    [Serializable()]
    public class NailFin2H1V : SubAssemblyBase
    {
        ...
        public NailFin2H1V()
        {
            ...
            this.ModelID = "System2110-NailFin2H1V";
        }
        ...
        public override void Build()
        {
            ...
            // NailerWidthExt
            part = new Part(4373, "NailerWidthExt", this, 1, m_subAssemblyWidth + nailFinAd);
            part.PartGroupType = "NailFin";
            part.PartLabel = "1)Miter/Square";
            m_parts.Add(part);
