...
namespace FrameWorks.Makes.System2110
{
    ...
    public class FrameSwingActRHR : SubAssemblyBase
    {
        ...
        public FrameSwingActRHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-FrameSwingActRHR";
        }
        ...
        public override void Build()
        {
            ...
            part = new Part(4352, "JamAlumL>|", this, 1, m_subAssemblyHieght);
            ...
            part = new Part(4352, "JamAlumR|<", this, 1, m_subAssemblyHieght);
            part.PartGroupType = "Frame";
            part.PartLabel = "1)MiterTop\r\n" +
