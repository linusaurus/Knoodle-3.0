...
namespace FrameWorks.Makes.System2110
{
    ...
    public class FrameNrwSldrPSSSXXXP : SubAssemblyBase
    {
        ...
        public FrameNrwSldrPSSSXXXP()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-FrameNrwSldrPSSSXXXP";
        }
        ...
        public override void Build()
        {
            ...
            // Top22mmTrackPSSSXXXP
            for (int i = 0; i < 4; i++)
            {
                part = new Part(4447, "Top22mmTrackPSSSXXXP", this, 1, (trackHelper.DoorPanelWidth * 4.0m) - stileOvrLpX2  + doorGap);
            ...
            //ShapedRubber -->> 
            part = new Part(3766, "ShapedRubber", this, 16, 0.0m);
            part.PartGroupType = "TopTrackUni";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(4730, "Bronze_HemoPSSSXXXP", this, 1, (trackHelper.DoorPanelWidth * 4.0m) - stileOvrLpX2 + doorGap);
            ...
            for (int i = 0; i < 4; i++)
            {
                part = new Part(4691, "CRL_SS_CVR", this, 1, (trackHelper.DoorPanelWidth * 4.0m) - stileOvrLpX2 + doorGap);
                part.PartGroupType = "HEMOLELE";
                part.PartLabel = "";
                m_parts.Add(part);
            }
            ...
            //PocketCushions 
            part = new Part(5151, "PocketCushion", this, 12, 0);
