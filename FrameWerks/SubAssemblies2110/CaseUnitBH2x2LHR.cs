...
namespace FrameWorks.Makes.System2110
{
    ...
    public class CaseUnitBH2x2LHR : SubAssemblyBase
    {
        ...
        public CaseUnitBH2x2LHR()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-CaseUnitBH2x2LHR";
        }
        ...
        public override void Build()
        {
            ...
            // Hinges
            part = new Part(3685, "Hinges", this, HingeCountAlum (m_subAssemblyHieght), 0.0m);
            part.PartGroupType = "Hardware";
        ...
        //HINGECOUNT_ALUMINUM
        private static int HingeCountAlum(decimal HingeAxisLength)
        {
            int result = 0;
