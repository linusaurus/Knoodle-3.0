...
namespace FrameWorks.Makes.System2110
{
    ...
    public class DrFRKN1LtActLH : SubAssemblyBase
    {

        #region Fields

        // The values we can change for different layouts
        const decimal railCut = 1.53125m;
        const decimal stopRedWIDE = 2.25m;
        const decimal stopReduce = 0.71875m;
        const decimal stopReduceX2 = 2.0m * 0.71875m;
        const decimal glsDrGpWd = 2.59375m;
