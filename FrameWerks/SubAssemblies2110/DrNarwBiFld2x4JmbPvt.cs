...
namespace FrameWorks.Makes.System2110
{
    ...
    public class DrNarwBiFld2x4JmbPvt : SubAssemblyBase
    {
        ...
        public DrNarwBiFld2x4JmbPvt()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System2110-DrNarwBiFld2x4JmbPvt";
        }
        ...
        public override void Build()
        {
            ...
            //Glass
            part = new Part(5785);
            part.FunctionalName = "Glass_2x4_SDL";
            part.PartGroupType = "Glass_2x4_SDL";
            part.Qnty = 1;
            ...
            // E4_Pivot_Set
            part = new Part(3719, "E4_Pivot_Set", this, 2, 0.0m);
            part.PartGroupType = "HardWare";
            part.PartLabel = "";
            m_parts.Add(part);

            // JMB_PIVOT_BKR (3)
            part = new Part(3983, "JMB_PIVOT_BKR (3)", this, 2, 0.0m);
            part.PartGroupType = "HardWare";
            part.PartLabel = "";
            m_parts.Add(part);

            // BI-FOLD HNG BKR (1)
            part = new Part(3982, "BI-FOLD HNG BKR (1)", this, 2, 0.0m);
            part.PartGroupType = "HardWare";
            part.PartLabel = "";
            m_parts.Add(part);
