...
namespace FrameWorks.Makes.System3340
{
    ...
    public class FrameSlidePXXXXX : SubAssemblyBase
    {
        ...
        const decimal stileOvrLpX4 = 4.0m * 1.125m;
        ...
        const decimal faceMidoor = 1.000m;
        ...
        public FrameSlidePXXXXX()
        {
            m_subAssemblyID = Guid.NewGuid();
            this.ModelID = "System3340-FrameSlidePXXXXX";
        }
        ...
        public override void Build()
        {
            ...
            //TopTrackYXXXXX
            part = new Part(4447, "TopTrackYXXXXX", this, 1, (trackHelper.DoorPanelWidth * 6.0m) - stileOvrLpX4 - jambInset + endCap + doorGap + pockYtrackAdd);
            ...
            //TopTrackYXXXX
            part = new Part(4447, "TopTrackYXXXX", this, 1, (trackHelper.DoorPanelWidth * 5.0m) - stileOvrLpX3 - jambInset + endCap + yTrAccess + pockYtrackAdd);
            part.PartGroupType = "TopTrackY-Parts";
            part.PartLabel = "";
            ...
            //TopTrackYXXX
            part = new Part(4447, "TopTrackYXXX", this, 1, (trackHelper.DoorPanelWidth * 4.0m) - stileOvrLpX2 - jambInset + endCap + yTrAccess + pockYtrackAdd);
            part.PartGroupType = "TopTrackY-Parts";
            part.PartLabel = "";
            ...
            // FaciaHeadExtXXXXX ^^
            part = new Part(4364, "FaciaHeadExtXXXXX", this, 1, (trackHelper.DoorPanelWidth) - jambInset - spltHdRed);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            ...
            // FaciaHd_4364_ExtXXXX ^^
            part = new Part(4364, "FaciaHd_4364_ExtXXXX", this, 1, (trackHelper.DoorPanelWidth) - faceMidoor);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            ...
            // FaciaHd_4364_ExtXXX ^^
            part = new Part(4364, "FaciaHd_4364_ExtXXX", this, 1, (trackHelper.DoorPanelWidth) - faceMidoor);
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "";
            ...
            for (int i = 1; i < panelCount; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 2:
                        {
                            temp[2] = (trackHelper.DoorPanelWidth * 3.0m) - stileOvrLpX4 - jambInset + pockYtrackAdd + endCap + notchHDPEadd;
                            notchHDPE += temp[2].ToString() + ",";
                            break;
                        }
                    case 3:
                        {
                            temp[3] = (trackHelper.DoorPanelWidth * 4.0m) - stileOvrLpX4 - jambInset + pockYtrackAdd + endCap + notchHDPEadd;
                            notchHDPE += temp[3].ToString() + ",";
                            break;
                        }
                    case 4:
                        {
                            temp[4] = (trackHelper.DoorPanelWidth * 5.0m) - stileOvrLpX4 - jambInset + pockYtrackAdd + endCap + notchHDPEadd;
                            notchHDPE += temp[3].ToString() + ",";
                            break;
                    ...
                    case 5:
                        {
                            temp[5] = (trackHelper.DoorPanelWidth * 6.0m) - stileOvrLpX4 - jambInset + pockYtrackAdd + endCap + headHDPEadd + notchHDPEadd;
                            notchHDPE += temp[3].ToString() + ",";
                            break;
                        }
            ...
            // HDPEHead ^^
            part = new Part(3454, "HDPE_Head", this, 1, (trackHelper.DoorPanelWidth * 6.0m) + (doorGap + jambCvrBrz + endCap) - (stileOvrLpX4 - jambInset));
            part.PartGroupType = "Frame-Parts";
            part.PartLabel = "Notch @ " + notchHDPE;
            part.PartThick = 0.75m;
            part.PartWidth = 10.125m;
