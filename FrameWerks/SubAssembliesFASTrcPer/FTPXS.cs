...
namespace FrameWorks.Makes.SubAssembliesFASTrcPerft
{
    class FTPXS : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            part = new Part(3444, "BladePX", this, 1, (trackHelper.DoorPanelWidth * 2.0m) - pocketInset + doorGap);
            ...
            part = new Part(3444, "BladePS", this, 1, (trackHelper.DoorPanelWidth * 2.0m) - pocketInset + doorGap);
            part.PartGroupType = "BladeSS-Parts";
            part.PartLabel = "";
