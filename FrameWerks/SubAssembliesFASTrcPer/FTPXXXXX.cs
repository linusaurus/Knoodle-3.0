...
namespace FrameWorks.Makes.SubAssembliesFASTrcPerft
{
    class FTPXXXXX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // BladePXXX
            part = new Part(3444, "BladePXXX", this, 1, trackHelper.DoorPanelWidth * 4 - stileWidth * 2 - pocketInset);
            part.PartGroupType = "BladeSS-Parts";
            part.PartLabel = "";
            ...
            // BladePXXXX
            part = new Part(3444, "BladePXXXX", this, 1, trackHelper.DoorPanelWidth * 5 - stileWidth * 3 - pocketInset);
            part.PartGroupType = "BladeSS-Parts";
            part.PartLabel = "";
            ...
            // BladePXXXXX
            part = new Part(3444, "BladePXXXXX", this, 1, trackHelper.DoorPanelWidth * 6 - stileWidth * 4 - pocketInset + jambThick);
            part.PartGroupType = "BladeSS-Parts";
            part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_PXXX", this, 1, trackHelper.DoorPanelWidth * 4 - stileWidth * 2 - pocketInset);
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_PXXXX", this, 1, trackHelper.DoorPanelWidth * 5 - stileWidth * 3 - pocketInset);
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_PXXXXX", this, 1, trackHelper.DoorPanelWidth * 6 - stileWidth * 4 - pocketInset  + jambThick);
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
