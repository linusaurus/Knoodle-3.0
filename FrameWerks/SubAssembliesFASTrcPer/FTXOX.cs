    ...
    class FTXOX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_X0", this, 1, trackHelper.DoorPanelWidth * 2.0m - stileWidth + bladeAdd + gapNCvr);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_O", this, 1, (trackHelper.DoorPanelWidth));
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_OX", this, 1, trackHelper.DoorPanelWidth * 2.0m - stileWidth + bladeAdd + gapNCvr);
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
