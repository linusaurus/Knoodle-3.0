...
namespace FrameWorks.Makes.SubAssembliesFASTrcPerft
{
    class FTXlOrX : SubAssemblyBase
    {
        ...
        public FTXlOrX()
        {
            ...
            this.ModelID = "LiftSlide-FTXlOrX";
        }
        ...
        public override void Build()
        {
            ...
            //BladeO
            part = new Part(3444, "BladeO", this, 1, (trackHelper.DoorPanelWidth / 2.0m) * 3.0m - stileCut  );
            part.PartGroupType = "BladeSS";
            part.PartLabel = "";
            m_parts.Add(part);
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4424, "PerfecT_O", this, 1, (trackHelper.DoorPanelWidth / 2.0m) * 3.0m - stileCut);
                part.PartGroupType = "PerfecTack";
                part.PartLabel = "";
                m_parts.Add(part);
            }
