...
namespace FrameWorks.Makes.SubAssembliesFASTrcPerft
{
    class FTPXX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // BladePXX
            part = new Part(3444, "BladePXX", this, 1, (trackHelper.DoorPanelWidth * 3) - stileWidth - pocketInset + bladeAdd);
            part.PartGroupType = "BladeSS";
            part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                part = new Part(4424, "PerfecT_PXX", this, 1, (trackHelper.DoorPanelWidth * 3) - stileWidth - pocketInset + bladeAdd);
                part.PartGroupType = "PerfecTack";
                part.PartLabel = "";
                m_parts.Add(part);
            }
