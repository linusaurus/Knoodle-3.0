...
namespace FrameWorks.Makes.SubAssembliesFASTrcPerft
{
    class FTOXXX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            part = new Part(3444, "BladeOXX", this, 1, (trackHelper.DoorPanelWidth * 3.0m) - (stileWidth * 2.0m) + bladeAdd);
            part.PartGroupType = "BladeSS-Parts";
            part.PartLabel = "";
            ...
            part = new Part(3444, "BladeOXXX", this, 1, (trackHelper.DoorPanelWidth * 4.0m) - (stileWidth * 3.0m) + (bladeAdd * 2.0m));
            part.PartGroupType = "BladeSS-Parts";
            part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_OXX", this, 1, (trackHelper.DoorPanelWidth * 3.0m) - (stileWidth * 2.0m) + bladeAdd);
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_OXXX", this, 1, (trackHelper.DoorPanelWidth * 4.0m) - (stileWidth * 3.0m) + (bladeAdd * 2.0m));
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
