...
namespace FrameWorks.Makes.SubAssembliesFASTrcPerft
{
    class FTPXXX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            // BladePXXX
            part = new Part(3444, "BladePXXX", this, 1, (trackHelper.DoorPanelWidth * 4) - (2 * stileWidth) - pocketInset + 0.125m);
            part.PartGroupType = "BladeSS-Parts";
            part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_PXXX", this, 1, (trackHelper.DoorPanelWidth * 4) - (2 * stileWidth) - pocketInset + 0.125m);
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
