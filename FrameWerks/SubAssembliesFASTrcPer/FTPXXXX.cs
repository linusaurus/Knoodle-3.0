    ...
    class FTPXXXX : SubAssemblyBase
    {
        ...
        public override void Build()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_PX", this, 1, trackHelper.DoorPanelWidth * 2.0m - pocketInset);
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_PXX", this, 1, (trackHelper.DoorPanelWidth * 3.0m) - stileWidth - pocketInset);
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_PXXX", this, 1, (trackHelper.DoorPanelWidth * 4.0m) - 2.0m * stileWidth - pocketInset);
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                part = new Part(4424, "PerfecT_PXXXX", this, 1, (trackHelper.DoorPanelWidth * 5.0m) - 3.0m * stileWidth - pocketInset + bladeAdd);
                part.PartGroupType = "PerfecTack-Parts";
                part.PartLabel = "";
